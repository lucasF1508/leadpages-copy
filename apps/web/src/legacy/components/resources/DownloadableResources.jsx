...
//images
import download_artisanalMarketingHandbook from '@legacy/assets/images/resources/downloads/artisanal-marketing-handbook_1216px@2x.jpg'
import download_conversionTacticsGenerator from '@legacy/assets/images/resources/downloads/conversion-tactic-generator_1216px@2x.jpg'
import download_copyhackersWorkbook from '@legacy/assets/images/resources/downloads/copyhackers-workbook_1216px@2x.jpg'
import download_facebookAdsLookbook from '@legacy/assets/images/resources/downloads/facebook-ads-lookbook_1216px@2x.jpg'
import download_findClientsEbook from '@legacy/assets/images/resources/downloads/find-and-book-dream-clients-book_808px@2x.jpg'
import download_gettingBusinessOnlineBook from '@legacy/assets/images/resources/downloads/getting-your-business-online-book_1216px@2x.jpg'
import download_landingPageLookbook from '@legacy/assets/images/resources/downloads/landing-page-lookbook_1216px@2x.jpg'
import download_seoChecklist from '@legacy/assets/images/resources/downloads/seo-checklist-for-small-businesses_808px@2x.jpg'
import download_webDesignHandbook from '@legacy/assets/images/resources/downloads/web-design-handbook_808px@2x.jpg'
import download_websiteGoalSettingWorkbook from '@legacy/assets/images/resources/downloads/website-goal-setting-workbook_808px@2x.jpg'
    ...
    <DownloadableResourcesContainer name="downloads">
      <HeadingFlexbox>
        <div>
          ...
          <CustomersSubHeading>
            Get the guides, checklists, and worksheets you need to market like a
            pro.
          </CustomersSubHeading>
        </div>
      </HeadingFlexbox>
      <ColumnFeatureOverlap
        image={download_conversionTacticsGenerator}
      ...
      />
      <ThreeColumnOverlap
        column1image={download_seoChecklist}
        ...
        column2image={download_webDesignHandbook}
        ...
        column3image={download_findClientsEbook}
      ...
      />
      <ThreeColumnOverlap
        column1image={download_websiteGoalSettingWorkbook}
        ...
        column2image={download_landingPageLookbook}
        ...
        column3image={download_copyhackersWorkbook}
      ...
      />
      <ThreeColumnOverlap
        column1image={download_gettingBusinessOnlineBook}
        ...
        column2image={download_artisanalMarketingHandbook}
        ...
        column3image={download_facebookAdsLookbook}
