...
export default function Animation_GuestBioPopup({
  cb,
  active = false,
  canceled = false,
  duration = 12000,
  ...
  const images = useStaticQuery(graphql`
    query GuestBioPopupAnimationQuery {
      headshot: file(
        relativePath: { eq: "assets/images/animations/guest-bio-popup_headshot.png" }
      ) {
        ...fixed
      }
      plants: file(relativePath: { eq: "assets/images/animations/guest-bio-popup_plants.jpg" }) {
        ...fixed
      }
      backgroundShape: file(
        relativePath: { eq: "assets/images/animations/guest-bio-popup_background-shape.jpg" }
      ) {
        ...fixed
      }
    }
  `);
  const headshotSrc = getSrc(images.headshot);
  const plantsSrc = getSrc(images.plants);
  const backgroundShapeSrc = getSrc(images.backgroundShape);
    ...
    >
      <g transform="translate(3 22)">
        ...
        <g fill="none" fillRule="evenodd">
          <image width="468" height="282" x="78" y="164" href={backgroundShapeSrc} />
          <g transform="translate(78 211)">
            <g transform="translate(25 32)">
              <image width="130" height="211" x="2" y="-43" href={headshotSrc} />
            </g>
            <g transform="translate(169 32)">
              ...
              >
                ...
                &nbsp;
                <tspan x="0" y="68.2">
                  ventures across Minnesota, Erna helps her clients cultivate&nbsp;
                </tspan>
                &nbsp;
                <tspan x="0" y="86.2">
            ...
            <path stroke="#575452" strokeLinecap="square" d="M169,155 L323.5,155" />
          </g>
          <polygon
            fill="#E7E6E6"
        ...
        <g id="pop-up" ref={popupContainer} opacity={0}>
          ...
          <g ref={popup} transform="translate(148 50)">
            ...
            <g transform="translate(0 257)">
              <image width="328" height="218.667" y="-72" href={plantsSrc} />
            </g>
          </g>
        </g>
        <path
