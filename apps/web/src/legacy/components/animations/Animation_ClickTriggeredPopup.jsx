...
import { useAnimationPlayPause, useAnimationCanceled } from '@legacy/components/animations/animationHooks'
// images
import seattle from '@legacy/assets/images/animations/click-triggered-popup_seattle.jpg'
...
const Animation_ClickTriggeredPopup = ({
  cb,
  active = false,
  canceled = false,
  duration = 12000,
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g id="pop-up" ref={popupContainer} opacity={0}>
            ...
            <g ref={popup} transform="translate(91 86)">
              <polygon
                fill="#0F0C09"
                points=".76 0 441.76 0 441.76 259.6 .76 259.6"
              />
              <polygon
                fill="#FFF"
                fillRule="nonzero"
...
export default Animation_ClickTriggeredPopup
