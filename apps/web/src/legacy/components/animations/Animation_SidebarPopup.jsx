    ...
    >
      <g transform="translate(3 22)">
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <polygon
            fill="#E7E6E6"
            points="203 207.5 251 207.5 251 504.5 203 504.5"
            transform="rotate(-90 227 356)"
          />
          <path
            fill="#FFF"
          ...
          <g filter="url(#sidebar-1-c)" transform="translate(148.857 141.5)">
            <path
              fill="#FFF"
              fillRule="nonzero"
          ...
          <text
            fill="#FFF"
            fontFamily="Superclarendon-Regular, Superclarendon"
            fontSize="22"
            letterSpacing="-.25"
          >
            <tspan x="417" y="144">
            ...
            &nbsp;
            <tspan x="468.844" y="244">
              x
            </tspan>
          </text>
          <g transform="translate(417 336)">
            <rect width="111" height="27" fill="#603EFF" rx="13.5" />
            <text
              fill="#FFF"
            ...
            <g transform="translate(36 44)">
              ...
              >
                ...
                <tspan
                  x="16.32"
                  y="40"
                  fontFamily="Superclarendon-Bold, Superclarendon"
                  fontWeight="bold"
                >
                  Food for Thought
                </tspan>
              </text>
              <g transform="translate(0 66.45)">
                <rect
                  width="208.294"
                  height="28.744"
                  x=".591"
