      ...
      <g transform="translate(3 22)">
        ...
        <g id="pop-up" ref={popupContainer} opacity={0}>
          ...
          <g ref={popup} transform="translate(148 50)">
            ...
            >
              <tspan x=".276" y="15.5">
                Where can we send your Landscape&nbsp;
              </tspan>
              &nbsp;
              <tspan x="49.308" y="39.5">
                Photography checklist?
              </tspan>
            </text>
            <g transform="translate(73 217)">
              <rect
                width="178.819"
                height="28.744"
                x=".591"
            ...
            <g transform="translate(72.546 262.375)">
              <rect width="180.317" height="32.93" fill="#8FEFEF" rx="16.465" />
              <text
                fill="#0F0C09"
                fontFamily="SourceSansPro-Bold, Source Sans Pro"
