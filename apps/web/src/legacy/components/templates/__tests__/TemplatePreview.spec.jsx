...
import { renderWithTheme, screen, fireEvent, waitFor } from '@testing-library/react';
...
describe('TemplatePreview', () => {
  ...
  it('should render a back button', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: 'Back to All Templates' }));
    expect(props.goBack).toHaveBeenCalled();
  });

  it('should render the template preview', () => {
    renderWithTheme(<TemplatePreview {...props} />);
    expect(screen.getByTitle('Preview')).toHaveAttribute('src', props.template.previewUrl);
  });
