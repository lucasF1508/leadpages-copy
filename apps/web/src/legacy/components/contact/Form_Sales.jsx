...
import {
  ErrorMessage_Main,
  Field_CompanyName,
  Field_CompanyWebsite,
  Field_Consent,
  Field_Email,
  Field_MarketingGoals,
  Field_MarketingStrategy,
  Field_MarketingTools,
  Field_Name,
  Field_PhoneNumber,
  SubmitButton,
} from './FormFields'

const Form_Sales = (props) => {
  ...
  const preSubmissionCheck = (e) => {
    ...
    if (
      ...
      window.dataLayer.push({
        ...
        formSelection: `Sales — ${props.selection}`,
        companyName:
  ...
  return (
    <FormContext {...methods}>
      <form
        id="dripform"
        action="https://www.getdrip.com/forms/710650059/submissions"
        method="post"
        data-drip-embedded-form="710650059"
      >
        <Grid
          container
          direction="row"
