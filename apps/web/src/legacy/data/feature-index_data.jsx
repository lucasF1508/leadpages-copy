export const featureIndexPageData = [
  {
    category: 'Builder',
    feature: '5 Free sub accounts',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Custom & hidden form fields',
    description:
      'Track and pass along any data you desire to your email service or CRM through pre-populated hidden form fields.',
  },
  {
    category: 'Builder',
    feature: 'Custom social media preview',
    description:
      'Add and customize your page’s Open Graph tags so you can have more control over how your content displays on social media networks.',
  },
  {
    category: 'Builder',
    feature: 'Device-specific preview',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Digital file hosting & delivery',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Duplicate & edit',
    description:
      'Have a great website, landing page, alert bar, or pop-up? Save time by copying and customizing your content without having to start from scratch.',
  },
  {
    category: 'Builder',
    feature: 'Easy drag-and-drop interface',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Lead backup/CSV download',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Lead gen form builder',
    description:
      'Easily drag and drop a form onto a webpage, landing page, pop-up, or alert bar, choose your fields, customize your design, and connect your integrations.',
  },
  {
    category: 'Builder',
  ...
  {
    category: 'Builder',
    feature: 'Mobile responsive pages',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Unlimited traffic & leads',
    description:
  ...
  {
    category: 'Builder',
    feature: 'Tracking and third-party analytics',
    description:
  ...
  },
  {
    ...
    feature: 'Widgets',
    description:
      'Add functionality to your webpages, landing pages and pop-ups with a variety of widgets including countdown timers, video, text, images, Calendly, OpenTable, and more.',
  },
  {
    category: 'Conversion Tools',
    feature: 'Clear campaign ROI',
    description:
  ...
  {
    category: 'Conversion Tools',
    feature: 'Real-time optimization tips',
    description:
      'With Leadmeter, get data-powered, real-time conversion tips at your fingertips, helping you build higher-performing landing pages so you can guess less and grow more.',
  },
  {
    category: 'Conversion Tools',
    feature: 'Third-party analytics',
    description:
      'Easily paste third-party tracking code, such as Google Analytics and your Facebook Pixel, into your webpages, landing pages, pop-ups, and alert bars.',
  },
  {
    category: 'Conversion Tools',
    feature: 'Unlimited A/B split testing',
    description:
      'Optimize your pages for conversions by running A/B split tests on any landing page.',
  },
  {
    category: 'Conversion Tools',
    feature: 'Unlimited alert bars',
    description:
      'Get your audience’s attention without getting in their way with the help of a non-intrusive, mobile-friendly alert bar across the width of any landing page or webpage.',
  },
  {
    category: 'Conversion Tools',
    feature: 'Unlimited pop-ups',
    description:
      'Create pop-up opt-in forms (Leadboxes®) to capture contact information on any landing page or webpage. Add click, exit intent, and timed display triggers.',
  },
  {
  ...
  {
    category: 'Design & Templates',
    feature: 'OpenTable embed widget',
    description:
      'Enable visitors to search available reservation times and book a table right from your webpage, landing page, or pop-up.',
  },
  {
    category: 'Design & Templates',
    feature: 'Countdown timers',
    description:
      'To add a sense of urgency to your offer, add a countdown timer directly to your webpage, landing page, or pop-up. Automatically redirect the visitor to a different page or hide the page section when the clock runs out.',
  },
  {
    category: 'Design & Templates',
  ...
  {
    category: 'Design & Templates',
    feature: 'Design from a blank page',
    description:
      'Not the template type? No problem. Simply start your web page or landing page from scratch and create any design, pulling in existing widgets and functionality wherever you like.',
  },
  {
    category: 'Design & Templates',
    feature: 'Global page style settings',
    description:
  ...
  {
    category: 'Design & Templates',
    feature: 'HTML & Custom Code Editing',
    description:
  ...
  {
    category: 'Design & Templates',
    feature: 'Calendly embed widget',
    description:
      'Display your Calendly appointment calendar and enable visitors to self-schedule a call or consultation right from your webpage, landing page, or pop-up.',
  },
  {
    category: 'Design & Templates',
  ...
  {
    category: 'Education & Support',
    feature: 'Phone, chat, & email support',
    description:
  ...
  },
  {
    ...
    description:
      '<p>We’ve created a complete owners manual for your Leadpages account, including step-by-step how-to articles and guidance. Visit <a href="https://support.leadpages.com/hc/en-us" rel="noopener">support.leadpages.com</a></p>',
  },
  {
    category: 'Education & Support',
  ...
  {
    category: 'Integrations',
    feature: 'Major email service integrations',
    description:
  ...
  {
    category: 'Publishing',
    feature: 'Connect your domain(s)',
    description:
      'Easily connect and publish your website or landing pages on a third-party domain.',
  },
  {
    category: 'Publishing',
  ...
  {
    category: 'Publishing',
    feature: 'Simple WordPress plugin',
    description:
      'Easily publish your landing pages and pop-ups to any WordPress site with just a few clicks; no DNS record or CNAME setup required. Simply install our plugin and start publishing.',
  },
  {
    category: 'Publishing',
    feature: 'Free Leadpages domain',
    description:
      'Don’t have a domain or hosting? Use ours! Every account comes with free hosting on a Leadpages domain.',
  },
  {
    category: 'Publishing',
    feature: 'Unlimited publishing to your domain or website',
    description:
  ...
  {
    category: 'Security',
    feature: 'Automatic SSL encryption',
    description:
  ...
  },
  {
    ...
    feature: 'Drag-and-drop website builder',
    description:
  ...
  {
    category: 'Site Builder',
    feature: 'Drag-and-drop website menu',
    description:
  ...
  {
    category: 'Site Builder',
    feature: 'Integrated conversion tools',
    description:
  ...
  {
    category: 'Site Builder',
    feature: 'Pre-built add-on pages',
    description:
  ...
  {
    category: 'Site Builder',
    feature: 'Website publishing',
    description:
      'All accounts come with the ability to publish a site to a free Leadpages Domain (yourname.lpages.co) plus a set number of connected domains (varies by plan type).',
  },
  {
    category: 'Site Builder',
    feature:
