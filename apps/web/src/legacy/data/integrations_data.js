import ActiveCampaignLogo from '@legacy/assets/images/integrations/activecampaign_50@2x.png'
import AcuityLogo from '@legacy/assets/images/integrations/acuity.jpg'
import amoCRMLogo from '@legacy/assets/images/integrations/amo-crm_logo_250px.jpg'
import AutopilotLogo from '@legacy/assets/images/integrations/autopilot-logo_50@2x.png'
import AWeberLogo from '@legacy/assets/images/integrations/aweber.png'
...
import ConstantContactLogo from '@legacy/assets/images/integrations/constantcontact_50@2x.png'
import ContactuallyLogo from '@legacy/assets/images/integrations/Contactually-logo_400px.jpg'
import ConvertKitLogo from '@legacy/assets/images/integrations/Convertkit_50@2x.png'
import DriftLogo from '@legacy/assets/images/integrations/drift.png'
import DripLogo from '@legacy/assets/images/integrations/drip_50@2x.png'
import DrupalLogo from '@legacy/assets/images/integrations/drupal-100px.jpg'
import Egoi from '@legacy/assets/images/integrations/e-goi.jpeg'
import EmmaLogo from '@legacy/assets/images/integrations/emma_50@2x.png'
import FacebookLogo from '@legacy/assets/images/integrations/facebook_50@2x.png'
import GetResponseLogo from '@legacy/assets/images/integrations/getresponse_50@2x.png'
import GmailLogo from '@legacy/assets/images/integrations/gmail-logo.png'
import GoogleAdsLogo from '@legacy/assets/images/integrations/Google_Ads.jpg'
import GoogleAnalyticsLogo from '@legacy/assets/images/integrations/Google-Analytics-125px_max.jpg'
import GoogleMapsLogo from '@legacy/assets/images/integrations/google-maps.jpg'
import GoogleSheetsLogo from '@legacy/assets/images/integrations/google-sheets.jpg'
import GoogleTagManagerLogo from '@legacy/assets/images/integrations/google-tag-manager-logo.png'
import GoToWebinarLogo from '@legacy/assets/images/integrations/gotowebinar-logo.png'
import GumroadLogo from '@legacy/assets/images/integrations/gumroad-logo.png'
import HotjarLogo from '@legacy/assets/images/integrations/hotjar2.png'
import HubSpotLogo from '@legacy/assets/images/integrations/hubspot-logo_50@2x.png'
import iContactLogo from '@legacy/assets/images/integrations/icontact.jpg'
import InfusionSoftLogo from '@legacy/assets/images/integrations/infusionsoft_50@2x.png'
import InstagramLogo from '@legacy/assets/images/integrations/Instagram_logo.jpg'
import IntercomLogo from '@legacy/assets/images/integrations/Intercom_50@2x.png'
import JavaScriptLogo from '@legacy/assets/images/integrations/javascript-logo.jpg'
import JoomlaLogo from '@legacy/assets/images/integrations/joomla.jpg'
import KlaviyoLogo from '@legacy/assets/images/integrations/klaviyo_logo.jpg'
import KlickTippLogo from '@legacy/assets/images/integrations/klick-tipp.png'
import LeadsBridgeLogo from '@legacy/assets/images/integrations/leadsbridge-logo.png'
import LinkedInLogo from '@legacy/assets/images/integrations/LinkedIn-ads-1000px-max.jpg'
import LionDeskLogo from '@legacy/assets/images/integrations/LionDesk_Logo.jpg'
import LiveCallLogo from '@legacy/assets/images/integrations/livecall_icon.jpg'
import LiveChatLogo from '@legacy/assets/images/integrations/live-chat.png'
import MadMimiLogo from '@legacy/assets/images/integrations/madmimi.jpg'
import MailchimpLogo from '@legacy/assets/images/integrations/Mailchimp_Logo-Vertical_Black@2x.jpg'
import MailerLiteLogo from '@legacy/assets/images/integrations/mailer-lite.jpg'
import ManyChatLogo from '@legacy/assets/images/integrations/manychat.png'
import MarketoLogo from '@legacy/assets/images/integrations/marketo_logo-300px.jpg'
import MondayLogo from '@legacy/assets/images/integrations/monday-logo.jpg'
import OntraportLogo from '@legacy/assets/images/integrations/ontraport_50@2x.png'
import OpenTableLogo from '@legacy/assets/images/integrations/Open-table_Logo_horizontal_RGB@2x.jpg'
import OtherAdvertisingPlatformsIcon from '@legacy/assets/images/integrations/other-advertising-platforms.jpg'
import PardotLogo from '@legacy/assets/images/integrations/pardot.jpg'
import PaypalLogo from '@legacy/assets/images/integrations/paypal_50@2x.png'
import PipeDriveLogo from '@legacy/assets/images/integrations/Pipedrive_50@2x.png'
import PoptinLogo from '@legacy/assets/images/integrations/Poptin_icon.jpg'
import SalesforceLogo from '@legacy/assets/images/integrations/salesforce.jpg'
...
import StripeLogo from '@legacy/assets/images/integrations/stripe_50@2x.png'
import SurveyMonkeyLogo from '@legacy/assets/images/integrations/survey-monkey.jpg'
import TaboolaLogo from '@legacy/assets/images/integrations/taboola-logo.jpg'
import TeachableLogo from '@legacy/assets/images/integrations/teachable.jpg'
import TimetradeLogo from '@legacy/assets/images/integrations/timetrade.jpg'
import TrelloLogo from '@legacy/assets/images/integrations/trello-mark-blue.jpg'
import TrustpilotLogo from '@legacy/assets/images/integrations/trust-pilot.jpg'
import TwilioLogo from '@legacy/assets/images/integrations/twilio-mark-red.jpg'
import TwitterLogo from '@legacy/assets/images/integrations/Twitter_Logo_Blue.jpg'
import TypeformLogo from '@legacy/assets/images/integrations/typeformlogo.jpg'
import VimeoLogo from '@legacy/assets/images/integrations/vimeo_50@2x.png'
import WebhooksLogo from '@legacy/assets/images/integrations/webhooks-100px.jpg'
import WebinarJamLogo from '@legacy/assets/images/integrations/webinarjam.jpg'
import WeeblyLogo from '@legacy/assets/images/integrations/weebly.jpg'
import WistiaLogo from '@legacy/assets/images/integrations/wistia_50@2x.png'
import WixLogo from '@legacy/assets/images/integrations/wix-logo.png'
...
export const integrationsArray = [
  ...
  },
  {
    ...
    category: 'CRM',
    description:
      'Create or update Zoho CRM contacts with new leads from Leadpages.',
    connection: 'Available Via Zapier',
    tooltip:
      'Zapier is a free application that allows you to connect and send data between thousands of different applications.',
    icon: ZoHoCRMLogo,
  ...
  },
  {
    ...
    tooltip:
      'Compatible applications work with Leadpages but may require you to copy and paste HTML or use a third-party tool to connect them to your Leadpages account. They also are not covered by our customer support team.',
    icon: OtherAdvertisingPlatformsIcon,
  },
  {
    integration: 'Taboola',
    category: 'Digital Advertising',
  ...
  },
  {
    ...
    category: 'Email Marketing',
    description:
      'Build email lists in Emma by collecting leads from the Leadpages platform.',
    connection: 'Integrated',
    tooltip:
      'Integrated applications have been specifically developed to connect with Leadpages, meaning they are listed within your Leadpages account and backed by our customer support team.',
    icon: EmmaLogo,
  ...
  },
  {
    ...
    category: 'Email Marketing',
    description:
      'Create or update Klaviyo subscribers from new Leadpages submissions.',
    connection: 'Available Via Zapier',
    tooltip:
      'Zapier is a free application that allows you to connect and send data between thousands of different applications.',
    icon: KlaviyoLogo,
  },
  {
    ...
    category: 'Email Marketing',
    description:
      'Create or update Klick-Tipp subscribers from new Leadpages submissions.',
    connection: 'Available Via Zapier',
    tooltip:
      'Zapier is a free application that allows you to connect and send data between thousands of different applications.',
    icon: KlickTippLogo,
