...
export async function getStaticProps(context) {
  ...
  return {
    props: {
      ...
      data: [
        {
          title: `Choose From 50+ Conversion-Driven Website Templates`,
          heroContent: `Grow your business faster when you start with a professionally-designed high-converting, mobile-responsive website template. Easily customize your site with our intuitive drag-and-drop builder.`,
          seo,
        },
      ],
    },
