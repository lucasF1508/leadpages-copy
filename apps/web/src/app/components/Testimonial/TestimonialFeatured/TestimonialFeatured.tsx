  ...
  return (
    <div className='flex flex-col gap-5 sm:gap-7 md:gap-8 max-w-6xl mx-auto'>
          ...
          <div className='flex flex-col gap-2 max-md:max-w-[33.25rem] text-light text-center mx-auto nav-break:mx-0'>
            {heading && (
              typeof heading === 'string' 
                ...
                : <Heading className='text-center' content={heading} />
            )}
            {subheading && (
              typeof subheading === 'string'
                ? <Heading className='type-body-sm sm:type-size-body-lg text-center' heading={subheading} />
                : <Heading className='type-body-sm sm:type-size-body-lg text-center' content={subheading} />
            )}
          </div>
        )}
      ...
      {showFeaturedGrid && !isMobile ? (
        ...
        <div className='flex gap-4 items-stretch relative max-w-5xl mx-auto'>
          {testimonials?.slice(0, 3).map((testimonial, i) => {
            ...
            return (
              <div
                ...
                className={clsx(
                  'flex-shrink-0 transition-all duration-[2000ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] cursor-pointer self-stretch relative',
                  isActive 
                    ? 'flex-[1_1_54%] md:flex-[1_1_52%] z-10' // Selected
                    : 'flex-[1_1_23%] md:flex-[1_1_24%] opacity-75 hover:opacity-100 transition-opacity duration-[1500ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] z-0' // Unselected: a bit wider
                )}
              >
                <div className={clsx(
        ...
        <div className={clsx(
          ...
          <div 
            className={clsx(
              'flex transition-transform duration-[1500ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)]',
            ...
            {(isMobile && showFeaturedGrid 
              ...
              return (
                <div 
                  className={clsx(
                    'min-w-0',
                    !isMobile && 'transition-opacity duration-[1500ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)]',
