...
export const schemaTemplateSettings = {
  ...
  fields: [
    ...G.group('content', [
      F.field('templateSettingsMessage', { name: 'contentMessage' }),
    ]),
    ...templateContentGroup,
    ...G.group('content', [
      F.reference('cta', {
    ...
    ...G.group('details', [
      F.field('templateSettingsMessage', { name: 'detailsMessage' }),
    ]),
    ...templateDetailsGroup,
    ...G.group('included', [
      F.field('templateSettingsMessage', { name: 'includedMessage' }),
    ]),
    ...templateIncludedGroup,
    ...G.group('reviews', [
      F.field('templateSettingsMessage', { name: 'reviewsMessage' }),
    ]),
    ...templateReviewsGroup,
  ],
  preview: {
