...
export const schemaExperiments = {
  ...
  fields: [
    ...
    F.string({
      ...
      readOnly: ({document}) => {
        const {_id, _createdAt} = document
        return (!_id.includes('drafts.') && _createdAt) || (!!_createdAt && _id)
      },
    }),
      ...
      of: [
        F.object({
            ...
            F.number({
              ...
              validation: (Rule) => [
                ...
                Rule.custom((value, {document}) => {
                  ...
                  return totalWeight < 1 ? true : 'Total weight of variants must be less than 1'
                }),
              ],
            }),
          ],
          preview: {
            ...
            prepare: ({page, weight}) => ({
              title: `${page}${weight ? `: ${weight * 100}%` : ': no page wieght set'}`,
            }),
          },
        }),
      ],
