...
var emotion__default = _interopDefault(emotion);
...
var GroupHeading = function GroupHeading(props) {
  ...
  return React__default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    emotion.css(getStyles('groupHeading', _objectSpread$1({
      theme: theme
    }, cleanProps))), {
      'group-heading': true
    }, className)
...
var Input = function Input(_ref2) {
  ...
  return React__default.createElement("div", {
    ...
    /*#__PURE__*/
    emotion.css(getStyles('input', _objectSpread$1({
      theme: theme
    }, props)))
...
var Menu = function Menu(props) {
  ...
  var cn = cx(
  /*#__PURE__*/
  (0, emotion__default.css)(getStyles('menu', props)), {
    menu: true
  }, className);
...
var MenuList = function MenuList(props) {
  ...
  return _react.default.createElement("div", {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('menuList', props)), {
      'menu-list': true,
      'menu-list--is-multi': isMulti
    }, className),
    ref: innerRef
...
var NoOptionsMessage = function NoOptionsMessage(props) {
  ...
  return _react.default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('noOptionsMessage', props)), {
      'menu-notice': true,
      'menu-notice--no-options': true
    }, className)
  }, innerProps), children);
...
var LoadingMessage = function LoadingMessage(props) {
  ...
  return _react.default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('loadingMessage', props)), {
      'menu-notice': true,
      'menu-notice--loading': true
    }, className)
  }, innerProps), children);
  ...
  _createClass(MenuPortal, [{
    ...
    value: function render() {
      ...
      var menuWrapper = _react.default.createElement("div", {
        ...
        /*#__PURE__*/
        (0, emotion__default.css)(getStyles('menuPortal', state))
      }, children);
...
var utils_1$1 = utils$2.preventTouchMove;
var utils_2$1 = utils$2.allowTouchMove;
var utils_3$1 = utils$2.preventInertiaScroll;
var utils_4$1 = utils$2.isTouchDevice;
...
function (_Component) {
  ...
  _createClass(ScrollLock, [{
    ...
    value: function componentDidMount() {
      ...
      if (target && (0, utils$2.isTouchDevice)()) {
        // Mobile Safari ignores { overflow: hidden } declaration on the body.
        target.addEventListener('touchmove', utils$2.preventTouchMove, this.listenerOptions); // Allow scroll on provided target

        if (touchScrollTarget) {
          touchScrollTarget.addEventListener('touchstart', utils$2.preventInertiaScroll, this.listenerOptions);
          touchScrollTarget.addEventListener('touchmove', utils$2.allowTouchMove, this.listenerOptions);
        }
      } // increment active scroll locks
    ...
    value: function componentWillUnmount() {
      ...
      if (target && (0, utils$2.isTouchDevice)()) {
        target.removeEventListener('touchmove', utils$2.preventTouchMove, this.listenerOptions);

        if (touchScrollTarget) {
          touchScrollTarget.removeEventListener('touchstart', utils$2.preventInertiaScroll, this.listenerOptions);
          touchScrollTarget.removeEventListener('touchmove', utils$2.allowTouchMove, this.listenerOptions);
        }
      }
    }
  }, {
...
var SelectContainer = function SelectContainer(props) {
  ...
  return _react.default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('container', props)), {
      '--is-disabled': isDisabled,
      '--is-rtl': isRtl
    }, className)
  }, innerProps), children);
  ...
  _createClass(ValueContainer, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: cx(
        /*#__PURE__*/
        (0, emotion__default.css)(getStyles('valueContainer', this.props)), {
          'value-container': true,
          'value-container--is-multi': isMulti,
          'value-container--has-value': hasValue
        }, className)
...
var IndicatorsContainer = function IndicatorsContainer(props) {
  ...
  return _react.default.createElement("div", {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('indicatorsContainer', props)), {
      'indicators': true
    }, className)
  }, children);
};
...
var DropdownIndicator = function DropdownIndicator(props) {
  ...
  return _react.default.createElement("div", _extends({}, innerProps, {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('dropdownIndicator', props)), {
      'indicator': true,
      'dropdown-indicator': true
    }, className)
...
var ClearIndicator = function ClearIndicator(props) {
  ...
  return _react.default.createElement("div", _extends({}, innerProps, {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('clearIndicator', props)), {
      'indicator': true,
      'clear-indicator': true
    }, className)
...
var IndicatorSeparator = function IndicatorSeparator(props) {
  ...
  return _react.default.createElement("span", _extends({}, innerProps, {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('indicatorSeparator', props)), {
      'indicator-separator': true
    }, className)
  }));
}; // ==============================
...
var LoadingIndicator = function LoadingIndicator(props) {
  ...
  if (!keyframesInjected) {
    // eslint-disable-next-line no-unused-expressions
    (0, emotion__default.injectGlobal)("@keyframes ", keyframesName, "{0%,80%,100%{opacity:0;}40%{opacity:1;}};");
    keyframesInjected = true;
  }
  ...
  return _react.default.createElement("div", _extends({}, innerProps, {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('loadingIndicator', props)), {
      'indicator': true,
      'loading-indicator': true
    }, className)
...
var Control = function Control(props) {
  ...
  return _react.default.createElement("div", _extends({
    ...
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('control', props)), {
      'control': true,
      'control--is-disabled': isDisabled,
      'control--is-focused': isFocused,
      'control--menu-is-open': menuIsOpen
...
var Group = function Group(props) {
  ...
  return _react.default.createElement("div", {
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('group', props)), {
      'group': true
    }, className)
...
var GroupHeading = function GroupHeading(props) {
  ...
  return _react.default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('groupHeading', _objectSpread({
      theme: theme
    }, cleanProps))), {
      'group-heading': true
    }, className)
...
var Input = function Input(_ref2) {
  ...
  return _react.default.createElement("div", {
    ...
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('input', _objectSpread({
      theme: theme
    }, props)))
  ...
  _createClass(MultiValue, [{
    ...
    value: function render() {
      ...
      var containerInnerProps = _objectSpread({
        className: cx(
        /*#__PURE__*/
        (0, emotion__default.css)(getStyles('multiValue', this.props)), {
          'multi-value': true,
          'multi-value--is-disabled': isDisabled
        }, className)
      }, innerProps);
      ...
      var labelInnerProps = {
        className: cx(
        /*#__PURE__*/
        (0, emotion__default.css)(getStyles('multiValueLabel', this.props)), {
          'multi-value__label': true
        }, className)
      };
      ...
      var removeInnerProps = _objectSpread({
        className: cx(
        /*#__PURE__*/
        (0, emotion__default.css)(getStyles('multiValueRemove', this.props)), {
          'multi-value__remove': true
        }, className)
      }, removeProps);
...
var Option = function Option(props) {
  ...
  return _react.default.createElement("div", _extends({
    ...
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('option', props)), {
      'option': true,
      'option--is-disabled': isDisabled,
      'option--is-focused': isFocused,
      'option--is-selected': isSelected
...
var Placeholder = function Placeholder(props) {
  ...
  return _react.default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('placeholder', props)), {
      'placeholder': true
    }, className)
  }, innerProps), children);
};
...
var SingleValue = function SingleValue(props) {
  ...
  return _react.default.createElement("div", _extends({
    className: cx(
    /*#__PURE__*/
    (0, emotion__default.css)(getStyles('singleValue', props)), {
      'single-value': true,
      'single-value--is-disabled': isDisabled
    }, className)
  }, innerProps), children);
...
function (_Component) {
  ...
  _createClass(Select, [{
    ...
    value: function renderInput() {
      ...
      var _this$commonProps = this.commonProps,
          cx = _this$commonProps.cx,
          theme$$1 = _this$commonProps.theme,
          selectProps = _this$commonProps.selectProps;
      return _react.default.createElement(Input, _extends({
        autoCapitalize: "none",
        autoComplete: "off",
...
var Creatable$1 = createCommonjsModule(function (module, exports) {
...
var CreatableReactSelect = unwrapExports(Creatable$1);
...
var DEFAULT_MIN_INPUT_HEIGHT = 38;
var DEFAULT_MAX_MENU_HEIGHT = 306; // https://react-select.com/styles

var selectStyles = {
  container: function container(styles, _ref) {
    var isDisabled = _ref.isDisabled;
    return objectSpread({}, styles, Theme.typographyDefs.bodyDefault, {
  ...
  control: function control(styles, props) {
    ...
    var _props$selectProps = props.selectProps,
        minInputHeight = _props$selectProps.minInputHeight,
        maxInputHeight = _props$selectProps.maxInputHeight,
        verticallyCentered = _props$selectProps.verticallyCentered;
    return objectSpread({}, styles, {
      borderColor: isFocused ? Theme.colors.blue : Theme.colors.grey,
      backgroundColor: "#fff",
      boxShadow: 'none',
      ...
      '&:hover': {
        borderColor: isFocused ? Theme.colors.blue : Theme.colors.greyDarker
      }
    });
  },
  dropdownIndicator: function dropdownIndicator(styles, props) {
    var _props$selectProps2 = props.selectProps,
        menuIsOpen = _props$selectProps2.menuIsOpen,
        isSearchable = _props$selectProps2.isSearchable;
    return objectSpread({}, styles, {
      color: "".concat(Theme.colors.greyDark, " !important"),
      transform: !isSearchable && menuIsOpen ? 'rotate(180deg)' : 'rotate(0)',
      transition: 'transform 0.2s ease'
    });
  },
  indicatorsContainer: function indicatorsContainer(styles, _ref2) {
    var selectProps = _ref2.selectProps;
    return objectSpread({}, styles, {
      alignItems: selectProps.verticallyCentered ? 'center' : 'flex-start'
    });
  },
  indicatorSeparator: function indicatorSeparator(styles, _ref3) {
  ...
  multiValueRemove: function multiValueRemove(styles, _ref4) {
    ...
    return objectSpread({}, styles, {
      color: '#fff',
      backgroundColor: isFocused && Theme.colors.blueDark,
      borderRadius: 0,
  ...
  option: function option(styles, _ref5) {
    ...
    return objectSpread({}, styles, {
      fontSize: 15,
      lineHeight: 1.2,
      backgroundColor: isSelected || isFocused ? Theme.colors.blue : null,
      color: isSelected || isFocused ? "#fff" : Theme.colors.greyDarker,
      padding: 9,
      borderRadius: 3
    });
  },
  placeholder: function placeholder(styles, _ref6) {
...
var selectTheme = function selectTheme(theme) {
  return objectSpread({}, theme, {
    borderRadius: 3,
    colors: objectSpread({}, theme.colors, {
      primary: Theme.colors.blue,
      primary25: Theme.colors.blueLighter,
      primary75: Theme.colors.blueLight,
...
var DropdownIndicator$1 = function DropdownIndicator(props) {
  var _props$selectProps3 = props.selectProps,
      isSearchable = _props$selectProps3.isSearchable,
      hasDropdownIndicator = _props$selectProps3.hasDropdownIndicator;
  return React__default.createElement(React.Fragment, null, hasDropdownIndicator && React__default.createElement(components.DropdownIndicator, props, isSearchable ? React__default.createElement("i", {
    className: emotion.cx('lp-icon', emotion.css(_templateObject()))
  }, "search") : React__default.createElement("i", {
    className: emotion.cx('lp-icon', emotion.css(_templateObject2()))
  }, "down_angle")));
};
...
function (_React$Component) {
  inherits(MultiSelect, _React$Component);
  ...
  function MultiSelect(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(MultiSelect).call(this, props));

    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "handleChange", function (selectedOptions, actionMeta) {
      var _this$props = _this.props,
          maxSelectedOptions = _this$props.maxSelectedOptions,
          onChange = _this$props.onChange;
      var maxSelectedOptionsReached = !!maxSelectedOptions && selectedOptions.length >= maxSelectedOptions;

      _this.setState({
        maxSelectedOptionsReached: maxSelectedOptionsReached,
    ...
    defineProperty(assertThisInitialized(assertThisInitialized(_this)), "noOptionsMessage", function (_ref8) {
      var inputValue = _ref8.inputValue;
      var _this$props2 = _this.props,
          maxSelectedOptionsMessage = _this$props2.maxSelectedOptionsMessage,
          noOptionsMessage = _this$props2.noOptionsMessage;
      var maxSelectedOptionsReached = _this.state.maxSelectedOptionsReached;
  ...
  createClass(MultiSelect, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          hasDropdownIndicator = _this$props3.hasDropdownIndicator,
          isCreatable = _this$props3.isCreatable,
          props = objectWithoutProperties(_this$props3, ["classNamePrefix", "label", "options", "hasDropdownIndicator", "isCreatable"]);

      var _this$state = this.state,
          maxSelectedOptionsReached = _this$state.maxSelectedOptionsReached,
          selectedOptions = _this$state.selectedOptions;
      return React__default.createElement(React.Fragment, null, label && React__default.createElement("div", {
        className: emotion.cx(emotion.css(Theme.typographyDefs.bodyDefault), defineProperty({}, "".concat(classNamePrefix, "__label"), classNamePrefix))
      }, label), isCreatable ? React__default.createElement(CreatableReactSelect, _extends_1({}, props, {
        ...
        isMulti: true
      })) : React__default.createElement(index$1$1, _extends_1({}, props, {
        classNamePrefix: classNamePrefix,
        options: maxSelectedOptionsReached ? selectedOptions : options,
        components: {
          DropdownIndicator: DropdownIndicator$1
  ...
  return MultiSelect;
}(React__default.Component); // Accepts all props for React Select v2: https://react-select.com/props
