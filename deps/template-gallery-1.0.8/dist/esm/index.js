...
var _ref3 = /*#__PURE__*/React.createElement(InputAdornment, {
  position: "start"
...
var TemplateSearch = function TemplateSearch(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    InputProps: {
      ...
      endAdornment: ((_inputRef$current = inputRef.current) === null || _inputRef$current === void 0 ? void 0 : _inputRef$current.value) && /*#__PURE__*/React.createElement(InputAdornment, {
        position: "end"
...
var _ref4 = /*#__PURE__*/React.createElement(FilterListIcon, null);
...
var SearchAndResults = function SearchAndResults(_ref3) {
  ...
  var above1024Breakpoint = useMediaQuery(function (theme) {
    return theme.breakpoints.up(1025);
  });
  var at480Breakpoint = useMediaQuery(function (theme) {
    return theme.breakpoints.up(480);
  });
  var ButtonComponent = at480Breakpoint ? Button : IconButton;
  var classes = useStyles$2();
  return /*#__PURE__*/React.createElement(Grid, {
    container: true,
    className: clsx(classes.root, className)
  }, filter && numTemplates > 0 && /*#__PURE__*/React.createElement(Grid, {
    container: true,
    direction: "column",
    justify: "center",
  ...
  }, "Showing ", /*#__PURE__*/React.createElement("b", null, filter), " templates"), /*#__PURE__*/React.createElement(Button, {
    variant: "text",
    onClick: onClearFilters,
    className: classes.button
  }, "Clear")))), /*#__PURE__*/React.createElement(TemplateSearch, {
    inputRef: inputRef,
    onChange: onChange,
    onClear: onClearInput,
    disabled: disableSearch
  }), onToggleSidebar && !above1024Breakpoint && /*#__PURE__*/React.createElement(ButtonComponent, {
    "aria-label": "Filter",
    className: classes.filterButton,
    onClick: onToggleSidebar
  }, _ref4, at480Breakpoint && /*#__PURE__*/React.createElement(Typography, {
...
process.env.NODE_ENV !== "production" ? SearchAndResults.propTypes = {
  onChange: _pt.func.isRequired,
  onClearInput: _pt.func.isRequired,
  onClearFilters: _pt.func.isRequired,
  filter: _pt.string,
  numTemplates: _pt.number.isRequired,
  className: _pt.string,
  disableSearch: _pt.bool.isRequired,
  onToggleSidebar: _pt.func
} : void 0;
...
var TemplateThumbnail = function TemplateThumbnail(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(Grid, {
    ...
    className: clsx(classes.overlay, showPlaceholder && classes.isLoading)
  }, /*#__PURE__*/React.createElement("div", {
    className: classes.imgContainer
  }, /*#__PURE__*/React.createElement("img", {
    className: classes.img,
    ...
    alt: "Loading"
  })))), hasLoaded && /*#__PURE__*/React.createElement("div", {
  ...
  }, onSelectTemplate && /*#__PURE__*/React.createElement(Button, {
  ...
  }, "Preview"))), isNew && /*#__PURE__*/React.createElement(Fade, {
    in: hasLoaded,
    timeout: {
      enter: 300,
      exit: 0
...
process.env.NODE_ENV !== "production" ? TemplateThumbnail.propTypes = {
  onPreviewTemplate: _pt.func.isRequired,
  onSelectTemplate: _pt.func
} : void 0;
...
var FilterSectionList = function FilterSectionList(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ListItem, {
    ...
    }, section && section === TaxonSection.Color && /*#__PURE__*/React.createElement("span", {
      className: classes.colorSwatch,
      style: {
        backgroundColor: taxonColorHexValue[option.value]
      }
    }), option.label, option.value === FEATURED_OPTION && /*#__PURE__*/React.createElement(Chip, {
      size: "small",
      className: classes.featuredChip,
      icon: /*#__PURE__*/React.createElement(GradeIcon, {
...
process.env.NODE_ENV !== "production" ? FilterSectionList.propTypes = {
  taxons: _pt.array.isRequired,
  currentValue: _pt.string.isRequired,
  isOpen: _pt.bool.isRequired,
  listItemClass: _pt.string.isRequired,
  section: _pt.string,
  onTransitionStart: _pt.func,
  onTransitionEnd: _pt.func
} : void 0;
...
var FilterSidebar = function FilterSidebar(_ref4) {
  ...
  var _useState = useState(expandedSection),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var timeoutRef = useRef(); // Do not show taxon label as the collapse transitions from open to closed
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: clsx(classes.listItem, classes.listItemSectionTitle, 'no-dropdown')
  }, /*#__PURE__*/React.createElement(Typography, {
    className: classes.listItemSectionCaption,
    variant: "caption",
    component: "span"
  }, "Sort By")), /*#__PURE__*/React.createElement(FilterSectionList, {
    taxons: orderByList,
    ...
    }, (selectedTaxon === null || selectedTaxon === void 0 ? void 0 : selectedTaxon.section) === kind && /*#__PURE__*/React.createElement(Button, {
      variant: "text",
    ...
    }, "Clear"), activeFilterSection === kind ? /*#__PURE__*/React.createElement(ExpandLess, {
      role: "button",
      className: classes.expandIcon
    }) : /*#__PURE__*/React.createElement(ExpandMore, {
      role: "button",
      className: classes.expandIcon
    })), showCollapsedLabel && activeFilterSection !== kind && (selectedTaxon === null || selectedTaxon === void 0 ? void 0 : selectedTaxon.section) === kind && /*#__PURE__*/React.createElement(Typography, {
      className: classes.activeTaxonLabel,
      variant: "caption",
      component: "span"
    }, selectedTaxon.label)), /*#__PURE__*/React.createElement(FilterSectionList, {
      taxons: taxons,
    ...
    }, /*#__PURE__*/React.createElement(FilterSectionList, {
      taxons: taxons,
      currentValue: collection === TaxonCollection.categories ? currentFilters.categories : currentFilters.tags,
      onSelect: collection === TaxonCollection.categories ? onUpdateCategory : onUpdateTag,
      isOpen: true,
  ...
  }), legacyPageRoute && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ListItem, {
    selected: true,
    disabled: true,
    className: classes.listItem
  }, "Drag & Drop"), /*#__PURE__*/React.createElement(Link, {
...
process.env.NODE_ENV !== "production" ? FilterSidebar.propTypes = {
  taxons: _pt.array.isRequired,
  onUpdateCategory: _pt.func.isRequired,
  onUpdateTag: _pt.func.isRequired,
  onSortSelect: _pt.func.isRequired,
  onClearFilter: _pt.func.isRequired,
  legacyPageRoute: _pt.string,
  onSectionTransitionStart: _pt.func,
  onSectionTransitionEnd: _pt.func,
  orderByList: _pt.array,
  excludedSections: _pt.array,
  listClass: _pt.string,
  listItemWidth: _pt.number
} : void 0;
...
process.env.NODE_ENV !== "production" ? NoResults.propTypes = {
  clearSearch: _pt.func.isRequired
} : void 0;
...
var PreviewTemplate = function PreviewTemplate(_ref3) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: clsx(classes.deviceWrapper, showMobile ? classes.mobileDeviceWrapper : classes.desktopDeviceWrapper)
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: classes.deviceControl
  })), !hasLoaded && /*#__PURE__*/React.createElement(CircularProgress, {
    className: classes.loader
  }), /*#__PURE__*/React.createElement("div", {
    className: clsx(classes.iframe, showMobile ? classes.mobileIframe : classes.desktopIframe)
...
process.env.NODE_ENV !== "production" ? PreviewTemplate.propTypes = {
  previewUrl: _pt.string.isRequired,
  device: _pt.oneOf(["mobile", "desktop"]).isRequired
} : void 0;

var TRANSITION_DURATION = 350;
var useStyles$8 = makeStyles(function (_ref) {
...
var _ref4$1 = /*#__PURE__*/React.createElement(ChevronLeft, null);

var _ref5 = /*#__PURE__*/React.createElement(ChevronRight, null);
...
var SidebarToggle = function SidebarToggle(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(Tooltip, {
    ...
    className: clsx(classes.root, buttonClassName, isOpen ? classes.collapseButton : classes.expandButton),
...
process.env.NODE_ENV !== "production" ? SidebarToggle.propTypes = {
  isOpen: _pt.bool.isRequired,
  onToggleSidebar: _pt.func.isRequired,
...
var useStyles$9 = makeStyles(function (_ref) {
  var breakpoints = _ref.breakpoints,
      palette = _ref.palette,
      transitions = _ref.transitions,
      spacing = _ref.spacing;
...
var _ref9 = /*#__PURE__*/React.createElement("style", {
  type: "text/css"
}, "\n          .no-scroll {\n            overflow: hidden;\n          }\n    ");
...
var ResponsiveSidebar = function ResponsiveSidebar(_ref8) {
  ...
  var slideMounted = useRef(false);
  useEffect(function () {
    slideMounted.current = true;
  }, []);
  return /*#__PURE__*/React.createElement(React.Fragment, null, above1024Breakpoint && !state.ui.sidebarOpen && /*#__PURE__*/React.createElement(SidebarToggle, {
    isOpen: false,
  ...
  }, "Done"))))), /*#__PURE__*/React.createElement(Drawer, {
    className: clsx(above1024Breakpoint ? classes.drawerDesktop : classes.drawer, drawerClass),
    classes: {
      paper: clsx(above1024Breakpoint ? classes.drawerPaperDesktop : classes.drawerPaper, drawerPaperClass),
  ...
  }, above1024Breakpoint && state.ui.sidebarOpen && /*#__PURE__*/React.createElement(SidebarToggle, {
    onToggleSidebar: actions.onToggleSidebar,
    isOpen: true
...
process.env.NODE_ENV !== "production" ? ResponsiveSidebar.propTypes = {
  drawerClass: _pt.string,
  drawerPaperClass: _pt.string,
  sidebarButtonClass: _pt.string
} : void 0;
...
function useTemplateState(_ref2) {
  ...
  var mandrelApi = useMemo(function () {
...
export { FilterSidebar, Gallery, NoResults, PreviewTemplate, ResponsiveSidebar, SearchAndResults, SidebarToggle, TemplateThumbnail, useInfiniteScrollRef, useTemplateState };
