...
export declare enum TaxonCollection {
    categories = "categories",
    tags = "tags",
    id = "id"
}
export declare enum TaxonSection {
...
export declare enum FilterProps {
    limit = "limit",
    cursor = "cursor",
    id = "id",
    name = "name",
...
export declare type AllTemplateFilters = {
...
export declare type TemplateFilters = Partial<AllTemplateFilters>;
export declare type GetTemplatesResponse = ApiResponse & {
    _meta: ListingMeta;
    _items: Template[];
};
export declare type GetTaxonsResponse = ApiResponse & {
    taxons: Taxon[];
};
export declare type GetTemplateByIdResponse = ApiResponse & Template;
