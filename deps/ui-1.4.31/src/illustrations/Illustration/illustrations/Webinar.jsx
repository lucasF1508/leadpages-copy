...
export default function Webinar({ width, height, ...props }) {
  return (
    <svg
...
Webinar.propTypes = { width: PropTypes.number, height: PropTypes.number };

Webinar.defaultProps = { width: 72, height: 72 };
