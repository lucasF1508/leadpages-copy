...
import { makeStyles, styled, useTheme as useTheme$1, createMuiTheme, lighten, ThemeProvider } from '@material-ui/core/styles';
...
var VSTypography = function VSTypography(props) {
...
var _ref4 = /*#__PURE__*/React.createElement(ArrowRight, null);

function FlyoutMenu(_ref2) {
  var placement = _ref2.placement,
      modifiers = _ref2.modifiers,
      menuItems = _ref2.menuItems,
      SubmenuProps = _ref2.SubmenuProps,
      onClickAway = _ref2.onClickAway,
      other = _objectWithoutProperties(_ref2, ["placement", "modifiers", "menuItems", "SubmenuProps", "onClickAway"]);
  ...
  return /*#__PURE__*/React.createElement(Popper, Object.assign({
    ...
    role: undefined,
    transition: true
  }, other), function (_ref3) {
    var TransitionProps = _ref3.TransitionProps;
    return /*#__PURE__*/React.createElement(Fade, TransitionProps, /*#__PURE__*/React.createElement(Paper, {
      elevation: 4
      ...
      var hasSubmenu = !!item.menuItems;
      var submenuId = hasSubmenu ? "".concat(key, "-submenu") : null;
      var onClick = hasSubmenu ? function (event) {
        return handleSubmenu(event, submenuId);
      } : item.onClick;
      var onMouseEnter = hasSubmenu ? function (event) {
        return handleSubmenu(event, submenuId);
      } : handleSubmenuClose;
      return !item.hidden && /*#__PURE__*/React.createElement(MenuItem, {
        key: key,
      ...
      }, item.label), hasSubmenu && _ref4, hasSubmenu && /*#__PURE__*/React.createElement(Popper, Object.assign({
        open: submenuOpen === submenuId,
        anchorEl: anchorEl,
        role: undefined,
        transition: true,
        disablePortal: true
      }, SubmenuProps), function (_ref5) {
        ...
        }, item.menuItems.map(function (subitem) {
          return !subitem.hidden && /*#__PURE__*/React.createElement(MenuItem, {
            className: classes.menuItem,
            onClick: subitem.onClick,
            disabled: subitem.disabled,
            key: "".concat(key, "-").concat(slugify(subitem.label)),
...
var useStyles$2 = makeStyles(function (theme) {
  return {
    ...
    shield: function shield(_ref) {
      var intensity = _ref.intensity,
          whiteWash = _ref.whiteWash;
      return {
        position: 'absolute',
        top: 0,
        bottom: 0,
...
function ClickShield(_ref2) {
  var isActive = _ref2.isActive,
      intensity = _ref2.intensity,
      whiteWash = _ref2.whiteWash,
      children = _ref2.children,
      rest = _objectWithoutProperties(_ref2, ["isActive", "intensity", "whiteWash", "children"]);
  ...
  var _child$props = child.props,
      ...
      childProps = _objectWithoutProperties(_child$props, ["children", "className"]);

  var newChildClassName = clsx(classes.root, childClassName);
  var shield = isActive ? /*#__PURE__*/React.createElement("div", {
    className: classes.shield,
    "data-qa-selector": "click-shield"
  }) : null;
  var newProps = childProps ? childProps : [];
  var newGrandChildren = childChildren ? React.Children.toArray(childChildren) : [];
  var Child = child.type;
  return /*#__PURE__*/React.createElement(Child, Object.assign({}, newProps, {
...
var navy = '#00044c';
var blue = '#0055cc';
var lightGray = '#B1BACC';
var lightGray25 = 'rgba(177,186,204,0.25)';
var black08 = 'rgba(0,0,0,.08)';
var black15 = 'rgba(0,0,0,0.15)';
var black50 = 'rgba(0, 0, 0, 0.50)';
var white15 = 'rgba(255,255,255,0.15)';
var white = '#FFFFFF';
var blueLightAlt = '#A4C8FD';
var blueLightAltHover = '#D1E3FE';
var blueLight = '#4692FF';
var blueDark = '#474C80';
var colors = {
...
var ColorPickerLabel = function ColorPickerLabel(_ref2) {
  var text = _ref2.text,
      labelAction = _ref2.labelAction,
      labelActionQaSelector = _ref2.labelActionQaSelector,
      labelActionText = _ref2.labelActionText,
      variant = _ref2.variant,
      className = _ref2.className,
      props = _objectWithoutProperties(_ref2, ["text", "labelAction", "labelActionQaSelector", "labelActionText", "variant", "className"]);

  var classes = useStyles$3();
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Typography, Object.assign({
    align: "left",
    variant: variant,
    className: "".concat(className, " ").concat(classes.label)
  }, props), text), labelAction && labelActionText && /*#__PURE__*/React.createElement(Link, {
    component: "button",
    onClick: labelAction,
...
var checkIsBlurEvent = function checkIsBlurEvent(e) {
  return e.type === BLUR_EVENT_TYPE && !(e.relatedTarget && e.relatedTarget.tagName.toLowerCase() === INPUT_TAG);
};

var SketchFields = function SketchFields(_ref) {
  var _ref$inputBehavior = _ref.inputBehavior,
      inputBehavior = _ref$inputBehavior === void 0 ? INPUT_BEHAVIOR.CHANGE : _ref$inputBehavior,
  ...
  var _useState3 = useState(false),
      _useState4 = _slicedToArray(_useState3, 2),
      isColorFocused = _useState4[0],
      setIsColorFocused = _useState4[1];

  var _useState5 = useState(opacity),
      _useState6 = _slicedToArray(_useState5, 2),
      currentOpacity = _useState6[0],
      setCurrentOpacity = _useState6[1];

  var setColorFocused = useCallback(function () {
  ...
  var isBlurOnly = inputBehavior === INPUT_BEHAVIOR.BLUR_ONLY;
  var isChange = inputBehavior === INPUT_BEHAVIOR.CHANGE;
  ...
  var handleColorChange = function handleColorChange(e) {
    ...
    if (color.isValid()) {
      ...
      return onChange(_extends({}, color.toRgb(), {
        source: 'rgb'
      }));
    }
  };
  ...
  var handleOpacityChange = function handleOpacityChange(e) {
    var value = e.target.value;
    var newOpacity = Math.min(parseInt(value, 10), 100);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Box, {
    ...
    item: true,
    xs: 5
  }, /*#__PURE__*/React.createElement(ColorPickerLabel, {
...
function getColorSwatchTitle(colorObj) {
  var colorSwatchTitle = colorObj.toHexString().toUpperCase();
...
var useStyles$5 = makeStyles({
  swatchWrap: function swatchWrap(props) {
    return {
      background: "url(".concat(checkboard$1.get(colors.white, colors.checkboardGray, 8), ") center left"),
      border: "3px solid ".concat(props.isSelected ? colors.swatchSelectedColor : colors.backgroundColor),
      borderRadius: 6,
...
var ColorPickerSwatch = function ColorPickerSwatch(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "".concat(classes.swatchWrap, " ").concat(className)
  }, /*#__PURE__*/React.createElement(index.Swatch, {
    color: color,
    title: getColorSwatchTitle(colorObj),
    onClick: onClick,
    onHover: onSwatchHover,
    focusStyle: {
      boxShadow: "inset 0 0 0 1px ".concat(colors.shadow, ", 0 0 4px ").concat(color)
    }
  }));
};
...
var SketchPresetColors = function SketchPresetColors(_ref) {
  var colors = _ref.colors,
      ...
      labelActionQaSelector = _ref.labelActionQaSelector,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Box, {
  ...
  }, label && /*#__PURE__*/React.createElement(ColorPickerLabel, {
    component: "h6",
    text: label,
    ...
    var isSelected = tinycolor.equals(tinycolor(c), selectedColor);
...
var useStyles$7 = makeStyles(function (_ref) {
  var typography = _ref.typography;
  return {
    saturation: {
      paddingBottom: '56%',
...
var usePointerStyles = makeStyles({
  pointer: {
    width: '8px',
    height: '8px',
    borderRadius: '2px',
    ...
    boxShadow: "0 1px 4px 0 ".concat(colors.shadowDark)
  }
});
...
var _ref3 = /*#__PURE__*/React.createElement(ArrowBack, null);

var CustomColorPicker = function CustomColorPicker(_ref2) {
  var inputBehavior = _ref2.inputBehavior,
      selectedColor = _ref2.selectedColor,
      onChange = _ref2.onChange,
      onClose = _ref2.onClose,
      renderTitle = _ref2.renderTitle;
  var classes = useStyles$7(selectedColor);
  var rgb = selectedColor.rgb,
      hsl = selectedColor.hsl,
      hsv = selectedColor.hsv,
      hex = selectedColor.hex;
  var rgbString = "rgba(".concat(rgb.r, ", ").concat(rgb.g, ", ").concat(rgb.b, ", ").concat(rgb.a, ")");
  return /*#__PURE__*/React.createElement(React.Fragment, null, renderTitle ? renderTitle({
    onClose: onClose
  }) : /*#__PURE__*/React.createElement(Grid, {
    container: true,
    alignItems: "center"
  ...
  }, _ref3), /*#__PURE__*/React.createElement(ColorPickerLabel, {
    component: "h6",
    text: "Custom Color",
    className: classes.customColorPickerTitle
  })), /*#__PURE__*/React.createElement("div", {
    className: classes.saturation
  }, /*#__PURE__*/React.createElement(index.Saturation, {
    hsl: hsl,
    hsv: hsv,
    onChange: onChange
  })), /*#__PURE__*/React.createElement(Grid, {
  ...
  }, /*#__PURE__*/React.createElement(index.Hue, {
    hsl: hsl,
    onChange: onChange,
    pointer: Pointer
  })), /*#__PURE__*/React.createElement(Grid, {
    ...
    xs: 12,
    className: classes.slider
  }, /*#__PURE__*/React.createElement(index.Checkboard, {
    white: colors.white
  }), /*#__PURE__*/React.createElement(index.Alpha, {
    rgb: rgb,
    hsl: hsl,
    onChange: onChange,
    pointer: Pointer
...
var getRgbString = function getRgbString(color) {
  return color.toRgbString ? color.toRgbString() : tinycolor(color).toRgbString();
};

var getRgbStrings = function getRgbStrings(presets, newColor) {
  var colors = newColor ? [newColor].concat(_toConsumableArray(presets)) : presets;
  return _toConsumableArray(new Set(colors.map(getRgbString)));
};

var Sketch = function Sketch(_ref) {
  var brandColors = _ref.brandColors,
      brandColorsAction = _ref.brandColorsAction,
      className = _ref.className,
      color = _ref.color,
      inputBehavior = _ref.inputBehavior,
      onChange = _ref.onChange,
      onCustomColorChoice = _ref.onCustomColorChoice,
      onOpenCustomColorPicker = _ref.onOpenCustomColorPicker,
      onSwatchHover = _ref.onSwatchHover,
      presetColors = _ref.presetColors,
      style = _ref.style,
      renderCustomTitle = _ref.renderCustomTitle;

  var _useState = useState(false),
      _useState2 = _slicedToArray(_useState, 2),
      isCustomColorPickerOpen = _useState2[0],
      setIsCustomColorPickerOpen = _useState2[1];

  var _useState3 = useState(false),
      _useState4 = _slicedToArray(_useState3, 2),
      customColorTouched = _useState4[0],
      setCustomColorTouched = _useState4[1];

  var _useState5 = useState(colorHelpers.toState({
  ...
  var _useState7 = useState(getRgbStrings(presetColors)),
      _useState8 = _slicedToArray(_useState7, 2),
      recentColors = _useState8[0],
      setRecentColors = _useState8[1];
  ...
  var handleOnCustomChange = useCallback(function (data, evt) {
    if (evt) {
      evt.preventDefault();
    }

    var newColor = colorHelpers.toState(data, data.h || customColor.oldHue);
  ...
  var handleOpenCustomColorPicker = useCallback(function () {
  ...
  return /*#__PURE__*/React.createElement(Paper, {
    elevation: 0,
    className: 'sketch-picker'.concat(" ", classes.picker, " ").concat(className),
    "data-qa-selector": "color-picker",
    style: style
  }, !isCustomColorPickerOpen && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SketchPresetColors, {
    colors: brandColors,
    onClick: onChange,
    ...
    labelActionText: "ADD",
    selectedColor: color
  })), isCustomColorPickerOpen && /*#__PURE__*/React.createElement(CustomColorPicker, {
    inputBehavior: inputBehavior,
    onClose: handleClose,
...
Sketch.defaultProps = {
  ...
  onOpenCustomColorPicker: function onOpenCustomColorPicker() {},
  style: null,
  inputBehavior: INPUT_BEHAVIOR.CHANGE,
...
var whiteTransparentColors = {
  100: "rgba(".concat(whiteRGB, ", 1)"),
  90: "rgba(".concat(whiteRGB, ", 0.9)"),
  85: "rgba(".concat(whiteRGB, ", 0.85)"),
  80: "rgba(".concat(whiteRGB, ", 0.8)"),
  70: "rgba(".concat(whiteRGB, ", 0.7)"),
  60: "rgba(".concat(whiteRGB, ", 0.6)"),
  50: "rgba(".concat(whiteRGB, ", 0.5)"),
  40: "rgba(".concat(whiteRGB, ", 0.4)"),
  30: "rgba(".concat(whiteRGB, ", 0.3)"),
  25: "rgba(".concat(whiteRGB, ", 0.25)"),
  20: "rgba(".concat(whiteRGB, ", 0.2)"),
  18: "rgba(".concat(whiteRGB, ", 0.18)"),
  10: "rgba(".concat(whiteRGB, ", 0.1)"),
  8: "rgba(".concat(whiteRGB, ", 0.08)"),
  5: "rgba(".concat(whiteRGB, ", 0.05)"),
  4: "rgba(".concat(whiteRGB, ", 0.04)"),
  0: "rgba(".concat(whiteRGB, ", 0)")
}; // Warm Greyscale palette is for the Marketing theme.
// Should be used for text, device borders, shape graphics, and backgrounds.

var warmGreyscaleColors = {
  100: '#0f0c09',
...
var warmGreyscaleRGB = '15, 12, 9';
var warmGreyscaleTransparentColors = {
  100: "rgba(".concat(warmGreyscaleRGB, ", 1)"),
  90: "rgba(".concat(warmGreyscaleRGB, ", 0.9)"),
  80: "rgba(".concat(warmGreyscaleRGB, ", 0.8)"),
  70: "rgba(".concat(warmGreyscaleRGB, ", 0.7)"),
  60: "rgba(".concat(warmGreyscaleRGB, ", 0.6)"),
  50: "rgba(".concat(warmGreyscaleRGB, ", 0.5)"),
  40: "rgba(".concat(warmGreyscaleRGB, ", 0.4)"),
  30: "rgba(".concat(warmGreyscaleRGB, ", 0.3)"),
  20: "rgba(".concat(warmGreyscaleRGB, ", 0.2)"),
  14: "rgba(".concat(warmGreyscaleRGB, ", 0.14)"),
  10: "rgba(".concat(warmGreyscaleRGB, ", 0.1)"),
  8: "rgba(".concat(warmGreyscaleRGB, ", 0.08)"),
  5: "rgba(".concat(warmGreyscaleRGB, ", 0.05)"),
  4: "rgba(".concat(warmGreyscaleRGB, ", 0.04)"),
  0: "rgba(".concat(warmGreyscaleRGB, ", 0)")
}; // Cool Greyscale palette is for the Product theme.
// Should be used for text, device borders, shape graphics, and backgrounds.

var coolGreyscaleColors = {
  100: '#090c12',
  90: '#212429',
  80: '#3a3d41',
  70: '#525459',
...
var coolGreyscaleRGB = '9, 12, 18';
var coolGreyscaleTransparentColors = {
  100: "rgba(".concat(coolGreyscaleRGB, ", 1)"),
  90: "rgba(".concat(coolGreyscaleRGB, ", 0.9)"),
  80: "rgba(".concat(coolGreyscaleRGB, ", 0.8)"),
  70: "rgba(".concat(coolGreyscaleRGB, ", 0.7)"),
  60: "rgba(".concat(coolGreyscaleRGB, ", 0.6)"),
  50: "rgba(".concat(coolGreyscaleRGB, ", 0.5)"),
  40: "rgba(".concat(coolGreyscaleRGB, ", 0.4)"),
  30: "rgba(".concat(coolGreyscaleRGB, ", 0.3)"),
  20: "rgba(".concat(coolGreyscaleRGB, ", 0.2)"),
  10: "rgba(".concat(coolGreyscaleRGB, ", 0.1)"),
  8: "rgba(".concat(coolGreyscaleRGB, ", 0.08)"),
  5: "rgba(".concat(coolGreyscaleRGB, ", 0.05)"),
  4: "rgba(".concat(coolGreyscaleRGB, ", 0.04)"),
  0: "rgba(".concat(coolGreyscaleRGB, ", 0)")
};
...
var Banner = function Banner(_ref2) {
  var className = _ref2.className,
      bannerText = _ref2.bannerText,
      CTA = _ref2.CTA,
      backgroundColor = _ref2.backgroundColor,
      color = _ref2.color,
      isShowing = _ref2.isShowing,
      isShown = _ref2.isShown,
      onShown = _ref2.onShown,
      other = _objectWithoutProperties(_ref2, ["className", "bannerText", "CTA", "backgroundColor", "color", "isShowing", "isShown", "onShown"]);
  ...
  var renderCTA = function renderCTA(element) {
    var config = {};
    ...
    return /*#__PURE__*/React.cloneElement(element, config);
  };
  ...
  }, bannerText), CTA && /*#__PURE__*/React.createElement("div", {
    className: classes.ctaContainer
  }, renderCTA(CTA))));
};

var WrappedBanner = function WrappedBanner(_ref3) {
  var selector = _ref3.selector,
      isShown = _ref3.isShown,
      props = _objectWithoutProperties(_ref3, ["selector", "isShown"]);

  var mountElement = useRef();
  useEffect(function () {
    mountElement.current = document.querySelector(selector);
  }, [selector]);

  var _useState = useState(isShown ? true : false),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, mountElement.current ? /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement(Banner, Object.assign({
    isShowing: isShowing,
    isShown: isShown
  }, props)), mountElement.current) : /*#__PURE__*/React.createElement(Banner, Object.assign({
    isShowing: isShowing,
    isShown: isShown
  }, props)));
};
...
var LogoFull = function LogoFull(_ref3) {
...
var LeadpagesLogo = function LeadpagesLogo(_ref5) {
  var variant = _ref5.variant,
      width = _ref5.width,
      props = _objectWithoutProperties(_ref5, ["variant", "width"]);

  var isFull = variant === 'full';
  var logoWidth = width !== undefined ? width : variant === 'icon' ? 32 : 144;

  if (!isFull) {
    return /*#__PURE__*/React.createElement(LogoIcon, Object.assign({
      width: logoWidth
    }, props));
  }

  return /*#__PURE__*/React.createElement(LogoFull, Object.assign({
    width: logoWidth
  }, props));
...
var useSuccess = (function (successCallback) {
  var successTimeout = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000;
...
var useStyles$b = makeStyles(function (_ref) {
...
var LoadingButton = function LoadingButton(props) {
  var className = props.className,
      ...
      other = _objectWithoutProperties(props, ["className", "children", "variant", "isLoading", "isSuccess", "fullWidth", "disabled", "successCallback", "successText", "successTimeout"]);

  var _useSuccess = useSuccess(successCallback),
      _useSuccess2 = _slicedToArray(_useSuccess, 2),
      showSuccess = _useSuccess2[0],
      setShowSuccess = _useSuccess2[1];
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, !isIcon && /*#__PURE__*/React.createElement(Button, Object.assign({
    classes: {
    ...
    fullWidth: fullWidth
  }, other), children), isIcon && /*#__PURE__*/React.createElement(IconButton, Object.assign({
    className: classes.iconButton,
    disabled: disabled || isLoading || showSuccess,
    "data-qa-selector": "loading-button-icon"
  }, other), showSuccess ? _ref5 : children), isLoading &&
  /*#__PURE__*/
  ...
  }), showSuccess && !isIcon && /*#__PURE__*/React.createElement(React.Fragment, null, successText ? /*#__PURE__*/React.createElement(Grid, {
    container: true,
    justify: "center",
    alignItems: "center",
  ...
  }), successText) : /*#__PURE__*/React.createElement(CheckIcon, {
    color: "primary",
    className: classes.progress
  })));
};
...
function css(styleFunction) {
  var newStyleFunction = function newStyleFunction(props) {
    ...
    if (props.css) {
      return _extends$1(_extends$1({}, merge$1(output, styleFunction(_extends$1({
        theme: props.theme
  ...
  newStyleFunction.propTypes = process.env.NODE_ENV !== 'production' ? _extends$1(_extends$1({}, styleFunction.propTypes), {}, {
...
var ShadowBoxButton = styled(ButtonBase)(styleFunction, {
...
var useStyles$c = makeStyles(function (theme) {
  ...
  var rgb = hexToRgb(palette.grey[100]).join(',');
  var shadowDefault = "0 10px 20px -5px ".concat(palette.greyTransparent[10]);
  var shadowRaised = "0 10px 20px -5px rgba(".concat(rgb, ", 0.25)");
  return {
    root: function root(_ref) {
...
var ShadowBox = function ShadowBox(props) {
  var component = props.component,
      className = props.className,
      raised = props.raised,
      other = _objectWithoutProperties(props, ["component", "className", "raised"]);
  ...
  if (component === 'button') {
    return /*#__PURE__*/React.createElement(ShadowBoxButton, Object.assign({
...
var useStyles$d = makeStyles(function (theme) {
  return {
    summaryRoot: {
      minHeight: 54,
      padding: "0 15px 0 ".concat(theme.spacing(3), "px "),
    ...
    summaryExpandIcon: function summaryExpandIcon(_ref) {
    ...
    accordion: function accordion(_ref2) {
...
function mergeClasses(cls1, cls2) {
  var newClasses = _extends({}, cls1);

  Object.keys(cls2).forEach(function (key) {
    newClasses[key] = newClasses[key] ? "".concat(newClasses[key], " ").concat(cls2[key]) : cls2[key];
  });
  return newClasses;
}

var _ref4$2 = /*#__PURE__*/React.createElement(ExpandMore, null);

function InfoSheet(_ref3) {
  var title = _ref3.title,
      children = _ref3.children,
      backgroundColor = _ref3.backgroundColor,
      textColor = _ref3.textColor,
      footerImage = _ref3.footerImage,
      AccordionProps = _ref3.AccordionProps,
      other = _objectWithoutProperties(_ref3, ["title", "children", "backgroundColor", "textColor", "footerImage", "AccordionProps"]);
  ...
  var accordionClasses = AccordionProps.classes,
      restAccordionProps = _objectWithoutProperties(AccordionProps, ["classes"]);

  var accordionProps = _extends({
    square: true,
  ...
  return /*#__PURE__*/React.createElement("div", other, /*#__PURE__*/React.createElement(Accordion, accordionProps, /*#__PURE__*/React.createElement(AccordionSummary, {
    expandIcon: _ref4$2,
    ...
    variant: "h5"
  }, title), typeof title !== 'string' && title)), /*#__PURE__*/React.createElement(AccordionDetails, {
    className: classes.content
  }, children), footerImage && /*#__PURE__*/React.createElement("div", {
    className: classes.footerImage
  }, typeof footerImage === 'string' && /*#__PURE__*/React.createElement("img", {
    src: footerImage,
    alt: ""
...
var _ref2$1 = /*#__PURE__*/React.createElement(HelpIcon, null);

var LabelAndTooltip = function LabelAndTooltip(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Grid, {
    ...
    item: true
  }, label, " ", required && '*'), /*#__PURE__*/React.createElement(Grid, {
...
var InputLabelWithTooltip = function InputLabelWithTooltip(props) {
  var renderInputLabelEl = props.renderInputLabelEl,
      other = _objectWithoutProperties(props, ["renderInputLabelEl"]);

  return /*#__PURE__*/React.createElement(React.Fragment, null, renderInputLabelEl && /*#__PURE__*/React.createElement(InputLabel, other, /*#__PURE__*/React.createElement(LabelAndTooltip, props)), !renderInputLabelEl && /*#__PURE__*/React.createElement(LabelAndTooltip, props));
};
...
var useStyles$f = makeStyles(function (_ref) {
  var spacing = _ref.spacing;
  return {
    closeButton: {
      position: 'absolute',
...
var _ref2$2 = /*#__PURE__*/React.createElement(CloseIcon, null);

var DialogTitleWithCloseButton = function DialogTitleWithCloseButton(props) {
  var className = props.className,
      children = props.children,
      TitleProps = props.TitleProps,
      CloseButtonProps = props.CloseButtonProps,
      onClose = props.onClose,
      other = _objectWithoutProperties(props, ["className", "children", "TitleProps", "CloseButtonProps", "onClose"]);

  var classes = useStyles$f();
  return /*#__PURE__*/React.createElement(DialogTitle, Object.assign({
    className: className,
    disableTypography: true
  }, other), /*#__PURE__*/React.createElement(Typography, Object.assign({
    component: "h2",
    variant: "h4"
  }, TitleProps), children), /*#__PURE__*/React.createElement(IconButton, Object.assign({
    className: classes.closeButton,
    onClick: onClose,
    "aria-label": "close"
  }, CloseButtonProps), _ref2$2));
};
...
var useStyles$g = makeStyles(function (_ref) {
  var spacing = _ref.spacing;
  return {
    subtitle: {
      marginBottom: 20
...
var ConfirmDialog = function ConfirmDialog(props) {
  var type = props.type,
      ...
      other = _objectWithoutProperties(props, ["type", "className", "children", "open", "titleText", "TitleProps", "subtitleText", "SubtitleProps", "descriptionText", "DescriptionProps", "confirmButtonText", "ConfirmButtonProps", "cancelButtonText", "CancelButtonProps", "onClose", "onConfirm"]);
  ...
  }, other), titleText && /*#__PURE__*/React.createElement(DialogTitleWithCloseButton, {
    onClose: onClose,
    TitleProps: _extends({
      id: 'confirmation-dialog-title'
    }, TitleProps)
  }, titleText), /*#__PURE__*/React.createElement(DialogContent, {
    id: "confirmation-dialog-description"
  }, !children && subtitleText && /*#__PURE__*/React.createElement(DialogContentText, Object.assign({
    className: classes.subtitle,
    component: "h3",
    variant: "h5"
  }, SubtitleProps), subtitleText), !children && descriptionText && /*#__PURE__*/React.createElement(DialogContentText, DescriptionProps, descriptionText), children), /*#__PURE__*/React.createElement(DialogActions, {
    className: classes.actions
  }, type !== 'alert' && /*#__PURE__*/React.createElement(LoadingButton, Object.assign({
    variant: "text",
    onClick: onClose,
    "data-qa-selector": "confirmation-dialog-cancel-button"
  }, CancelButtonProps), cancelButtonText), /*#__PURE__*/React.createElement(LoadingButton, Object.assign({
    variant: "contained",
    onClick: onConfirm,
...
var useStyles$h = makeStyles({
  ...
  swatch: function swatch(swatchOpacity) {
    return {
      height: '100%',
      left: 0,
      overflow: 'hidden',
...
var WistiaEmbed = function WistiaEmbed(_ref) {
  var videoId = _ref.videoId,
      embedOptions = _ref.embedOptions,
      onVideoPlay = _ref.onVideoPlay,
      onVideoPause = _ref.onVideoPause,
      onVideoEnd = _ref.onVideoEnd;

  var _useState = useState(0),
      _useState2 = _slicedToArray(_useState, 2),
      swatchOpacity = _useState2[0],
      setSwatchOpacity = _useState2[1];

  var classes = useStyles$h(swatchOpacity);

  var showSwatch = function showSwatch() {
    return setSwatchOpacity(1);
  };

  useEffect(function () {
    var id = "wistia-".concat(videoId);

    if (!document.getElementById(id)) {
      var script1 = document.createElement('script');
      script1.src = "https://fast.wistia.com/embed/medias/".concat(videoId, ".jsonp");
      script1.async = true;
      script1.id = id;
    ...
    var embedConfig = {
      id: videoId,
      options: _extends({}, defaultEmbedOptions, embedOptions),
      onReady: function onReady(video) {
        if (onVideoPlay) {
          video.bind('play', function () {
            return onVideoPlay(videoId);
          });
        }

        if (onVideoPause) {
          video.bind('pause', function () {
            var percentWatched = video.percentWatched();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: clsx("wistia_embed wistia_async_".concat(videoId), classes.embed)
  }, /*#__PURE__*/React.createElement("div", {
    className: clsx('wistia_swatch', classes.swatch)
  }, /*#__PURE__*/React.createElement("img", {
    src: "https://fast.wistia.com/embed/medias/".concat(videoId, "/swatch"),
...
var DARK_HOVER_STATE = function DARK_HOVER_STATE(color) {
  return {
    '&:hover, &.Mui-focusVisible': {
...
var _ref = /*#__PURE__*/React.createElement(ErrorOutlineIcon, null);

var _ref2$3 = /*#__PURE__*/React.createElement(CheckCircleOutlineIcon, null);

var _ref3$1 = /*#__PURE__*/React.createElement(WarningIcon, null);

var _ref4$3 = /*#__PURE__*/React.createElement(InfoIcon, null);
  ...
  return {
    ...
    content: function content(_ref6) {
      var variant = _ref6.variant,
          hasIconCloseButton = _ref6.hasIconCloseButton,
...
var _ref9 = /*#__PURE__*/React.createElement(CloseIcon, null);
...
var Toast = function Toast(_ref8) {
  var open = _ref8.open,
      ...
      textButtonClassName = _ref8.textButtonClassName,
      iconButtonClassName = _ref8.iconButtonClassName,
      buttonLabel = _ref8.buttonLabel,
      hasIconCloseButton = _ref8.hasIconCloseButton,
      variant = _ref8.variant,
      autoHideDuration = _ref8.autoHideDuration,
      props = _objectWithoutProperties(_ref8, ["open", "onClose", "severity", "message", "detail", "layout", "className", "textButtonClassName", "iconButtonClassName", "buttonLabel", "hasIconCloseButton", "variant", "autoHideDuration"]);

  var classes = useStyles$i({
    variant: variant,
    hasIconCloseButton: hasIconCloseButton,
    severity: severity,
    layout: layout
  });
  return /*#__PURE__*/React.createElement(Snackbar, Object.assign({
    ...
    open: open,
    onClose: onClose
  }, props), /*#__PURE__*/React.createElement(SnackbarContent, {
    classes: {
      root: classes.content,
      message: classes.message
    },
    message: layout === 'alert' ? /*#__PURE__*/React.createElement("div", {
      className: classes.messageWrapper
    }, severity && /*#__PURE__*/React.createElement("div", {
      className: classes.severityIcon
    }, getIconBySeverity(severity)), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Typography, {
      variant: "h6"
    }, message), detail && /*#__PURE__*/React.createElement(Typography, {
    ...
    action: /*#__PURE__*/React.createElement(React.Fragment, null, hasIconCloseButton ? /*#__PURE__*/React.createElement(IconButton, {
      className: clsx(classes.button, iconButtonClassName),
      "aria-label": "close",
      onClick: onClose
    }, _ref9) : /*#__PURE__*/React.createElement(Button, {
    ...
    root: {
      ...
      '& .MuiPhoneNumber-flagButton': {
        ...
        '&:after': {
          ...
          borderTop: "5px solid ".concat(palette.greyTransparent[70])
        },
        '&:hover, &:focus': {
      ...
      '& .MuiPhoneNumber-positionStart': {
        '&:after': {
          ...
          right: 0,
          height: 24,
          borderRight: "1px solid ".concat(palette.greyTransparent[30])
        }
      }
    },
    dropdown: {
...
var PhoneInput = function PhoneInput(props) {
  var className = props.className,
      ...
      other = _objectWithoutProperties(props, ["className", "defaultCountry", "disableAreaCodes", "dropdownClass", "excludeCountries"]);

  var classes = useStyles$j();
  return /*#__PURE__*/React.createElement(MuiPhoneInput, Object.assign({
    className: clsx(classes.root, className),
...
function UserCheckList(_ref) {
  var checklist = _ref.checklist;
  var classes = useStyles$k();
  return /*#__PURE__*/React.createElement(React.Fragment, null, checklist.map(function (_ref2, index) {
    var label = _ref2.label,
        passed = _ref2.passed;
    var Icon = passed ? CheckCircleIcon : CancelIcon;
    var iconClass = "".concat(classes.icon, " ").concat(passed ? classes.iconPassed : '');
    return /*#__PURE__*/React.createElement("div", {
      key: index,
...
var useStyles$l = makeStyles(function (theme) {
  return {
    paper: {
      position: 'relative',
      boxShadow: "0 10px 20px -5px ".concat(theme.palette.greyTransparent[50]),
...
function ArrowPopper(props) {
  var children = props.children,
      ...
      title = props.title,
      rest = _objectWithoutProperties(props, ["children", "containerClassName", "PaperProps", "title"]);

  var classes = useStyles$l(props);

  var paperClassName = PaperProps.className,
      paperPropsRest = _objectWithoutProperties(PaperProps, ["className"]);

  var Tip = /*#__PURE__*/React.createElement(Paper, Object.assign({
    className: clsx(classes.paper, paperClassName)
  }, paperPropsRest), /*#__PURE__*/React.createElement("div", {
...
var useStyles$m = makeStyles(function (_ref) {
  var spacing = _ref.spacing,
      typography = _ref.typography;
  return {
    root: function root(_ref2) {
      var overflowX = _ref2.overflowX;
      return {
        padding: 0,
        overflowX: overflowX,
...
var EntityTable = function EntityTable(props) {
  var className = props.className,
      children = props.children,
      overflowX = props.overflowX,
      TableProps = props.TableProps,
      other = _objectWithoutProperties(props, ["className", "children", "overflowX", "TableProps"]);
  ...
  return /*#__PURE__*/React.createElement(TableContainer, Object.assign({
    className: clsx(classes.root, className),
    component: ShadowBox
  }, other), /*#__PURE__*/React.createElement(Table, TableProps, children));
};
...
var FullScreenDialog = function FullScreenDialog(_ref) {
  var isOpen = _ref.isOpen,
      children = _ref.children,
      other = _objectWithoutProperties(_ref, ["isOpen", "children"]);
...
var FullScreenDialogTitle = function FullScreenDialogTitle(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "h1"
  }, headline), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    alignItems: "center",
    justify: justify,
...
var _ref2$4 = /*#__PURE__*/React.createElement(CloseIcon, null);

var FullScreenDialogHeader = function FullScreenDialogHeader(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Grid, {
    ...
    className: clsx(classes.root, className),
    justify: "space-between"
  }, /*#__PURE__*/React.createElement(LeadpagesLogo, {
    ...
    onClick: onClose,
    "aria-label": "close"
  }, _ref2$4), (breadcrumbs === null || breadcrumbs === void 0 ? void 0 : breadcrumbs.length) > 0 && /*#__PURE__*/React.createElement(Breadcrumbs, {
...
var useStyles$q = makeStyles(function (_ref) {
  var palette = _ref.palette;
  return {
    root: {
      cursor: 'pointer',
...
function UnderlineLink(_ref2) {
  var variant = _ref2.variant,
      typographyVariant = _ref2.typographyVariant,
      children = _ref2.children,
      className = _ref2.className,
      props = _objectWithoutProperties(_ref2, ["variant", "typographyVariant", "children", "className"]);
...
var _ref2$5 = /*#__PURE__*/React.createElement(VisibilityIcon, null);

var _ref3$2 = /*#__PURE__*/React.createElement(VisibilityOffIcon, null);
  ...
  return /*#__PURE__*/React.createElement(TextField, Object.assign({
    ...
    InputProps: {
      endAdornment: /*#__PURE__*/React.createElement(InputAdornment, {
        ...
        "aria-label": "".concat(showPassword ? 'Hide' : 'Show', " ").concat(label),
        onClick: function onClick() {
          return setShowPassword(!showPassword);
        },
        tabIndex: "-1"
      }, showPassword ? _ref2$5 : _ref3$2))
    } // eslint-disable-next-line react/jsx-no-duplicate-props
    ,
    inputProps: {
      'aria-label': label
...
var useStyles$r = makeStyles(function (_ref) {
  var typography = _ref.typography;
  return {
    label: _extends({}, typography.label)
  };
}, {
  classNamePrefix: 'InputLabelWithCount'
});
function InputLabelWithCount(_ref2) {
  var label = _ref2.label,
      value = _ref2.value;
  ...
  return /*#__PURE__*/React.createElement(Grid, {
    ...
    variant: "caption",
    color: "inherit"
  }, (value === null || value === void 0 ? void 0 : value.length) > 0 && "".concat(value.length, " characters")));
}
...
var LIST_ITEM_STATUS = {
  COMPLETE: 'complete',
  INCOMPLETE: 'incomplete'
};
var ItemSummary = withStyles(function (_ref) {
  var palette = _ref.palette,
  ...
  return {
    root: {
      ...
      '&:not(.Mui-expanded):hover': {
        boxShadow: "0 10px 20px -5px ".concat(palette.greyTransparent[20])
      },
...
var useStyles$s = makeStyles$1(function (_ref2) {
  ...
  return {
    ...
    summaryLabel: function summaryLabel(_ref3) {
    ...
    orderCircle: function orderCircle(_ref4) {
...
var _ref6 = /*#__PURE__*/React.createElement(ExpandMore, null);

var ChecklistItem = function ChecklistItem(_ref5) {
  var open = _ref5.open,
      name = _ref5.name,
      label = _ref5.label,
      order = _ref5.order,
      status = _ref5.status,
      DetailsComponent = _ref5.DetailsComponent,
      onOpen = _ref5.onOpen,
      onAccordionChange = _ref5.onAccordionChange,
      onStatusChange = _ref5.onStatusChange,
      onOpenNextItem = _ref5.onOpenNextItem,
      onLinkClick = _ref5.onLinkClick,
      onActionClick = _ref5.onActionClick,
      onItemClosing = _ref5.onItemClosing;
  var classes = useStyles$s({
    expanded: open
  });

  var handleOpen = function handleOpen(name) {
    onAccordionChange(name);
    if (name) onOpen(name);
  };

  return /*#__PURE__*/React.createElement(Accordion, {
    id: "checklist-item-".concat(name),
    classes: {
      root: classes.itemRoot
    },
    expanded: open,
    onChange: function onChange(event, expanded) {
      return handleOpen(expanded ? name : null);
    },
    TransitionProps: {
  ...
  }, /*#__PURE__*/React.createElement(ItemSummary, {
    "aria-label": label,
    expandIcon: _ref6
  }, status === LIST_ITEM_STATUS.COMPLETE ? /*#__PURE__*/React.createElement(CheckCircleIcon, {
    className: classes.checkCircle,
    "data-qa-selector": "item-".concat(order, "-checked")
  }) : /*#__PURE__*/React.createElement(Typography, {
    className: classes.orderCircle,
    align: "center",
    component: "span",
    "data-qa-selector": "item-".concat(order)
  }, order), /*#__PURE__*/React.createElement(Typography, {
    className: classes.summaryLabel,
    variant: "subtitle2"
  }, label)), /*#__PURE__*/React.createElement(AccordionDetails, {
    classes: {
      root: classes.itemDetails
    }
  }, DetailsComponent && /*#__PURE__*/React.createElement(DetailsComponent, {
    itemName: name,
    itemStatus: status,
...
var ItemSummary$1 = withStyles(function (_ref) {
  var palette = _ref.palette,
      transitions = _ref.transitions;
  return {
    root: {
...
var useStyles$t = makeStyles$1(function (_ref2) {
  var palette = _ref2.palette,
      typography = _ref2.typography;
  return {
    root: {
      borderTop: "1px solid ".concat(palette.greyTransparent[10]),
      boxShadow: 'none',
      position: 'absolute',
      bottom: 0,
      width: '100%'
...
var _ref4$4 = /*#__PURE__*/React.createElement(ExpandMore, null);

var FixedBottomItem = function FixedBottomItem(_ref3) {
  var open = _ref3.open,
      name = _ref3.name,
      label = _ref3.label,
  ...
  }, /*#__PURE__*/React.createElement(ItemSummary$1, {
    "aria-label": label,
    expandIcon: _ref4$4
  }, /*#__PURE__*/React.createElement(Typography, {
    className: classes.summaryLabel,
...
var CompletionProgressBar = withStyles(function (theme) {
  return {
    root: {
      height: 7,
      borderRadius: 5
...
var useStyles$u = makeStyles$1(function (theme) {
  return {
    paperAnchorRight: function paperAnchorRight(_ref) {
      var topOffset = _ref.topOffset;
      return {
        width: 360,
        top: topOffset ? topOffset : 0,
        height: topOffset ? "calc(100% - ".concat(topOffset, "px)") : '100%',
        border: 0,
        boxShadow: "0 10px 20px -5px ".concat(theme.palette.greyTransparent[10])
      };
    },
    dialogTitle: {
    ...
    listWrapper: function listWrapper(_ref2) {
      var bottomItem = _ref2.bottomItem;
      return {
...
var _ref5$1 = /*#__PURE__*/React.createElement(Divider, null);

function Checklist(_ref3) {
  var open = _ref3.open,
      list = _ref3.list,
      topOffset = _ref3.topOffset,
      bottomItemLabel = _ref3.bottomItemLabel,
      bottomItemComponent = _ref3.bottomItemComponent,
      onClose = _ref3.onClose,
      onStatusChange = _ref3.onStatusChange,
      onItemExpand = _ref3.onItemExpand,
      onBottomItemExpand = _ref3.onBottomItemExpand,
      onLinkClick = _ref3.onLinkClick,
      onActionClick = _ref3.onActionClick;

  var _useState = useState(),
      _useState2 = _slicedToArray(_useState, 2),
      activeListItem = _useState2[0],
      setActiveListItem = _useState2[1];

  var _useState3 = useState(false),
      _useState4 = _slicedToArray(_useState3, 2),
      itemClosing = _useState4[0],
      setItemClosing = _useState4[1];

  var _useState5 = useState(true),
      _useState6 = _slicedToArray(_useState5, 2),
      displayContent = _useState6[0],
      setDisplayContent = _useState6[1];
  ...
  var progressPercentage = Math.round(complete / listTotal * 100);

  var handleOpenNextItem = function handleOpenNextItem(currentOpenItem, itemStatus) {
    var currentIndex = list.findIndex(function (listItem) {
      return listItem.name === currentOpenItem;
    });
  ...
  return /*#__PURE__*/React.createElement(Drawer, {
  ...
  }, displayContent && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(DialogTitleWithCloseButton, {
    className: classes.dialogTitle,
    onClose: onClose
  }, 'Help & Getting Started'), _ref5$1, /*#__PURE__*/React.createElement("div", {
    className: classes.progressWrapper
  }, /*#__PURE__*/React.createElement(Typography, {
    className: classes.pageProgressTitle,
    variant: "h5"
  }, "Page Completion"), /*#__PURE__*/React.createElement(CompletionProgressBar, {
    ...
    variant: "caption"
  }, "".concat(complete, "/").concat(listTotal, " Complete")), progressPercentage === 100 && /*#__PURE__*/React.createElement(Typography, {
    className: classes.pageProgressMessage,
    variant: "caption"
  }, "Great\u2014ready for visitors!"))), /*#__PURE__*/React.createElement("div", {
    className: classes.listWrapper
  }, list && list.length >= 1 && list.map(function (_ref6, index) {
    var name = _ref6.name,
        label = _ref6.label,
        status = _ref6.status,
        DetailsComponent = _ref6.DetailsComponent;
  ...
  })), bottomItemComponent && /*#__PURE__*/React.createElement(FixedBottomItem, {
...
Checklist.defaultProps = {
  ...
  onBottomItemExpand: function onBottomItemExpand() {},
  onLinkClick: function onLinkClick() {},
  onActionClick: function onActionClick() {}
};
...
function ChecklistItemDetails(_ref) {
  var children = _ref.children,
      itemName = _ref.itemName,
      itemStatus = _ref.itemStatus,
      nextButtonLabel = _ref.nextButtonLabel,
      onStatusChange = _ref.onStatusChange,
      onOpenNextItem = _ref.onOpenNextItem;
  ...
  return /*#__PURE__*/React.createElement("div", null, children, /*#__PURE__*/React.createElement(Grid, {
    container: true,
    justify: "flex-end"
  }, /*#__PURE__*/React.createElement(Button, {
    onClick: handleClickNext,
    "data-qa-selector": "".concat(itemName, "-next-button")
  }, nextButtonLabel)));
}
...
var useStyles$v = makeStyles(function (_ref) {
  var spacing = _ref.spacing;
  return {
    dialogPaper: {
      maxWidth: 475
...
function ChecklistCelebrationModal(_ref2) {
  var open = _ref2.open,
      imgSrc = _ref2.imgSrc,
      imgAlt = _ref2.imgAlt,
      onClose = _ref2.onClose;
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
    ...
    onClose: onClose,
    fullWidth: true
  }, /*#__PURE__*/React.createElement(DialogTitleWithCloseButton, {
    onClose: onClose
    ...
    component: "h2",
    variant: "h3"
  }, "Way to go!"), /*#__PURE__*/React.createElement(Typography, {
    className: classes.contentText
  }, "You're one step closer to more leads & sales."), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    justify: "center"
  }, /*#__PURE__*/React.createElement(Button, {
  ...
  return {
    root: function root(_ref) {
      ...
      return _extends({
        ...
        position: 'fixed',
        bottom: 0,
        boxShadow: "0 6px 20px ".concat(theme.palette.greyTransparent[10], ", 0 12px 40px ").concat(theme.palette.greyTransparent[14]),
    ...
    linkRoot: function linkRoot(_ref2) {
    ...
    linkHover: function linkHover(_ref3) {
      ...
      return {
        '&:hover, &.Mui-focusVisible': {
          ...
          textDecoration: 'none',
          color: textColor,
          borderBottom: "2px solid ".concat(textColor)
        }
      };
    },
    linkArrow: {
...
var BundleInfoSheet = function BundleInfoSheet(_ref4) {
  var className = _ref4.className,
      backgroundColor = _ref4.backgroundColor,
      textColor = _ref4.textColor,
      title = _ref4.title,
      contentHeader = _ref4.contentHeader,
      contentBody = _ref4.contentBody,
      imageSrc = _ref4.imageSrc,
      isDefaultOpen = _ref4.isDefaultOpen,
      position = _ref4.position,
      linkLabel = _ref4.linkLabel,
      linkURL = _ref4.linkURL,
      onCollapseChange = _ref4.onCollapseChange;
  var classes = useStyles$w({
    position: position,
    textColor: textColor
  });
  return /*#__PURE__*/React.createElement(InfoSheet, {
    ...
    footerImage: imageSrc && /*#__PURE__*/React.createElement("div", {
      style: {
  ...
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(VSTypography, {
    className: classes.contentHeader,
    variant: "h5"
  }, contentHeader), /*#__PURE__*/React.createElement(Typography, {
    className: classes.content,
    component: "div",
    variant: "body2"
  }, contentBody), linkURL && linkLabel && /*#__PURE__*/React.createElement(Typography, {
    component: "div",
    variant: "body2"
    ...
    href: linkURL,
    target: "_blank"
  }, linkLabel), /*#__PURE__*/React.createElement(ArrowForwardIosIcon, {
...
var _ref3$3 = /*#__PURE__*/React.createElement(Link, {
  href: "mailto:support@leadpages.com"
}, "support@leadpages.com");

var FeedbackTool = function FeedbackTool(_ref) {
  var closeModal = _ref.closeModal,
      hasRequestedFeedback = _ref.hasRequestedFeedback,
      open = _ref.open,
      onSubmit = _ref.onSubmit,
      kind = _ref.kind,
      setRequestedFeedback = _ref.setRequestedFeedback,
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", setHasError(true));
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, hasRequestedFeedback ? /*#__PURE__*/React.createElement(ConfirmDialog, {
    classes: {
    ...
    descriptionText: /*#__PURE__*/React.createElement(React.Fragment, null, "If you don\u2019t see an email confirming your submission, make sure to check your spam folder. If you still don\u2019t see it or have any other issues, contact us at", ' ', _ref3$3, "."),
    ConfirmButtonProps: {
      variant: 'text'
    }
    ...
    onClose: onClose,
    open: open,
    titleText: "Get Feedback on Your ".concat(kind),
    ConfirmButtonProps: {
    ...
    paragraph: true
  }, "Feeling stuck or just need a little nudge? Submit your ", kind.toLowerCase(), " for feedback, and Leadpages staff will review it and email you with a detailed list of how to optimize it for conversion."), /*#__PURE__*/React.createElement(TextField, {
    label: "Questions",
    fullWidth: true,
    multiline: true,
    rows: 4,
    ...
    onChange: onChange,
    error: hasError
  })), /*#__PURE__*/React.createElement(Toast, Object.assign({
    message: "Your ".concat(kind.toLowerCase(), " has been submitted for feedback."),
    onClose: closeToast,
    open: showToast
  }, ToastProps)));
};
...
function Squiggle(_ref) {
  var SquiggleComponent = _ref.component,
      pathProps = _ref.pathProps,
      repeatCount = _ref.repeatCount,
      shellProps = _ref.shellProps;

  var repeatDef = _toConsumableArray(Array(repeatCount)).map(function () {
    return ' t 90 0';
  }).join('');

  return /*#__PURE__*/React.createElement(SquiggleComponent, shellProps, /*#__PURE__*/React.createElement("path", Object.assign({
    fill: "transparent",
    d: "M0 80 Q 45 40, 90 80".concat(repeatDef)
  }, pathProps)));
}
...
var _ref$1 = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("polygon", {
  id: "leadpages-logo-a",
...
function Logo (props) {
  return /*#__PURE__*/React.createElement("svg", Object.assign({
    ...
    height: "24",
    viewBox: "0 0 144 24"
  }, props), _ref$1, _ref2$6);
}

var useStyles$y = makeStyles(function (_ref) {
  var palette = _ref.palette,
  ...
  return {
    ...
    gridFooterContainer: _defineProperty$2({
...
var _ref3$4 = /*#__PURE__*/React.createElement(Typography, {
  variant: "body2",
  align: "center"
}, "\xA9 2021 Leadpages (US) Inc.");

function Onboarding(_ref2) {
  ...
  }, paperProps), children)), /*#__PURE__*/React.createElement(Grid, {
    item: true,
  ...
  }, _ref3$4), /*#__PURE__*/React.createElement(Grid, {
    item: true,
...
var _ref2$l = /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("path", {
  id: "thank-you-a",
...
var _ref3$5 = /*#__PURE__*/React.createElement("g", {
  fill: "none",
  fillRule: "evenodd",
...
var propsEnum = ['AboutMeBio', 'AlertBar', 'ComingSoon', 'ContestGiveaway', 'DiscountCoupon', 'ENewsletter', 'Event', 'FreeConsultation', 'FreeResource', 'GenerateLeads', 'LandingPage', 'MakeSales', 'PopUp', 'SomethingElse', 'ThankYou', 'Webinar', 'WebinarEvent', 'Website'];
...
function Illustration(_ref) {
  var illustrationType = _ref.illustrationType,
      props = _objectWithoutProperties(_ref, ["illustrationType"]);

  var IllustrationComponent = IllustrationComponents[illustrationType];
  return /*#__PURE__*/React.createElement(IllustrationComponent, props);
}
...
var inputDisabledPlaceholderStyles = function inputDisabledPlaceholderStyles(_ref2) {
  var palette = _ref2.palette;
  return {
    opacity: 1,
...
var checkboxAndRadioStyles = function checkboxAndRadioStyles(_ref3) {
...
var sharedOverrides = (function (theme) {
  var _root2;
  ...
  return {
    ...
    MuiFilledInput: {
      ...
      input: {
        padding: '12px 16px',
        '&::-webkit-input-placeholder': _extends({}, inputPlaceholderStyles(theme), {
          lineHeight: 'normal'
        })
        ...
        // IE 10+
        '&$disabled::-webkit-input-placeholder': _extends({}, inputDisabledPlaceholderStyles(theme), {
          lineHeight: 'normal'
        })
        /* Chrome/Opera/Safari/Edge */
        ,
      ...
      underline: {
        '&:before, &:hover:before': {
          borderBottom: "1px solid ".concat(palette.greyTransparent[30])
        },
    ...
    MuiFormLabel: {
      root: _extends({}, typography.label, {
        color: palette.text.primary,
    ...
    MuiCheckbox: _extends({}, checkboxAndRadioStyles(theme)),
    MuiRadio: _extends({}, checkboxAndRadioStyles(theme)),
    MuiBackdrop: {
      root: {
    ...
    MuiDialog: {
      paper: {
        boxShadow: "0 10px 20px -5px ".concat(palette.greyTransparent[50])
      }
    },
    ...
    MuiMenuItem: {
      ...
      }, _defineProperty$2(_root2, breakpoints.up('sm'), null), _defineProperty$2(_root2, "transition", transitions.create('background-color', {
        duration: transitions.duration.shortest
      })), _defineProperty$2(_root2, '&:hover, &.Mui-focusVisible', {
        backgroundColor: palette.action.hover,
        outline: 0,
        transition: transitions.create('background-color', {
          duration: 20
        })
      }), _defineProperty$2(_root2, '&:active', {
        backgroundColor: palette.action.active
      }), _root2)
    },
    MuiListSubheader: {
      root: _extends({}, typography.overline, {
        color: palette.greyTransparent[50],
        lineHeight: typography.pxToRem(28),
        paddingTop: 6,
        paddingBottom: 6
    ...
    MuiBreadcrumbs: {
      root: _extends({}, typography.button),
      li: {
        '&:before': {
    ...
    MuiSwitch: {
      ...
      colorPrimary: {
        ...
        '&$checked:hover, &$checked.Mui-focusVisible': {
          backgroundColor: "rgba(".concat(hexToRgb(palette.primary.main), ", 0.1) !important")
        },
        '&$checked:active': {
          backgroundColor: "rgba(".concat(hexToRgb(palette.primary.main), ", 0.2) !important")
        }
      },
      thumb: {
        boxShadow: shadows[2],
    ...
    MuiTableCell: {
      root: {
        borderBottom: "1px solid ".concat(palette.grey[10]),
        paddingTop: 19,
        paddingLeft: spacing(3),
        paddingBottom: 19,
        paddingRight: spacing(3)
      },
      head: _extends({}, typography.label, {
...
var sharedProps = {
  MuiAlert: {
    severity: 'error',
    iconMapping: {
      success: /*#__PURE__*/React.createElement(CheckCircleOutlineIcon, {
        fontSize: "inherit"
      })
    }
  },
...
var typography$1 = (function (theme) {
  var typography = theme.typography;
  var fontWeightRegular = typography.fontWeightRegular,
...
var sharedPalette = {
  ...
  whiteTransparent: _extends({}, whiteTransparentColors)
};

var palette$1 = _extends({}, sharedPalette, {
  action: {
  ...
  grey: _extends({}, coolGreyscaleColors),
  greyTransparent: _extends({}, coolGreyscaleTransparentColors)
});

var MEDIUM_BUTTON_VERTICAL_PADDING = 8;
var MEDIUM_BUTTON_HORIZONTAL_PADDING = 16;

var mediumButtonStyles = function mediumButtonStyles() {
  return {
    padding: "".concat(MEDIUM_BUTTON_VERTICAL_PADDING, "px ").concat(MEDIUM_BUTTON_HORIZONTAL_PADDING, "px")
  };
};

var LARGE_BUTTON_VERTICAL_PADDING = 14;
var LARGE_BUTTON_HORIZONTAL_PADDING = 24;

var largeButtonStyles = function largeButtonStyles(typography) {
  return {
    fontSize: typography.pxToRem(15),
    padding: "".concat(LARGE_BUTTON_VERTICAL_PADDING, "px ").concat(LARGE_BUTTON_HORIZONTAL_PADDING, "px")
  };
};

var OUTLINE_BUTTON_BORDER_WIDTH = 1;
var overrides = (function (_ref) {
  ...
  return _extends({
    MuiButton: {
      root: _extends({}, mediumButtonStyles()),
      text: _extends({}, mediumButtonStyles()),
      outlinedPrimary: {
        padding: "\n          ".concat(MEDIUM_BUTTON_VERTICAL_PADDING - OUTLINE_BUTTON_BORDER_WIDTH, "px\n          ").concat(MEDIUM_BUTTON_HORIZONTAL_PADDING - OUTLINE_BUTTON_BORDER_WIDTH, "px\n        "),
        border: "".concat(OUTLINE_BUTTON_BORDER_WIDTH, "px solid ").concat(palette.primary.main),
        '&:hover, &$focusVisible': {
          backgroundColor: palette.primary.dark,
        ...
        '&:active': {
          backgroundColor: secondaryColors.navy,
          border: "".concat(OUTLINE_BUTTON_BORDER_WIDTH, "px solid ").concat(palette.primary.dark),
          color: palette.common.white
        },
        '&$disabled': {
          border: "".concat(OUTLINE_BUTTON_BORDER_WIDTH, "px solid ").concat(palette.primary.light),
          color: palette.primary.light
        }
      },

      /* Styles applied to the root element if `size="large"` and `variant="contained". */
      containedSizeLarge: _extends({}, largeButtonStyles(typography)),

      /* Styles applied to the root element if `size="large"` and `variant="text". */
      textSizeLarge: _extends({}, largeButtonStyles(typography)),

      /* Styles applied to the root element if `size="large"` and `variant="outlined"`. */
      outlinedSizeLarge: _extends({}, largeButtonStyles(typography), {
        padding: "\n          ".concat(LARGE_BUTTON_VERTICAL_PADDING - OUTLINE_BUTTON_BORDER_WIDTH, "px\n          ").concat(LARGE_BUTTON_HORIZONTAL_PADDING - OUTLINE_BUTTON_BORDER_WIDTH, "px\n        ")
      })
    },
    MuiChip: {
      root: {
...
var productTheme = function productTheme() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var _options$variant = options.variant,
      variant = _options$variant === void 0 ? 'light' : _options$variant;
...
var SMALL_BUTTON_VERTICAL_PADDING = 6;
var SMALL_BUTTON_HORIZONTAL_PADDING = 24;

var smallButtonStyles = function smallButtonStyles(typography) {
  return {
    fontSize: typography.pxToRem(14),
    padding: "".concat(SMALL_BUTTON_VERTICAL_PADDING, "px ").concat(SMALL_BUTTON_HORIZONTAL_PADDING, "px"),
    borderRadius: 24
  };
};

var MEDIUM_BUTTON_VERTICAL_PADDING$1 = 12;
var MEDIUM_BUTTON_HORIZONTAL_PADDING$1 = 36;

var mediumButtonStyles$1 = function mediumButtonStyles(typography) {
  return {
    padding: "".concat(MEDIUM_BUTTON_VERTICAL_PADDING$1, "px ").concat(MEDIUM_BUTTON_HORIZONTAL_PADDING$1, "px"),
    borderRadius: 24
  };
};

var LARGE_BUTTON_VERTICAL_PADDING$1 = 16;
var LARGE_BUTTON_HORIZONTAL_PADDING$1 = 36;

var largeButtonStyles$1 = function largeButtonStyles(typography) {
  return {
    fontSize: typography.pxToRem(18),
    padding: "".concat(LARGE_BUTTON_VERTICAL_PADDING$1, "px ").concat(LARGE_BUTTON_HORIZONTAL_PADDING$1, "px"),
    borderRadius: 28
  };
};

var OUTLINE_BUTTON_BORDER_WIDTH$1 = 3;
var overrides$1 = (function (_ref) {
  var palette = _ref.palette,
      typography = _ref.typography;
  return {
    MuiButton: {
      root: _extends({}, mediumButtonStyles$1()),
      text: _extends({}, mediumButtonStyles$1()),
      outlinedPrimary: {
        padding: "\n        ".concat(MEDIUM_BUTTON_VERTICAL_PADDING$1 - OUTLINE_BUTTON_BORDER_WIDTH$1, "px\n        ").concat(MEDIUM_BUTTON_HORIZONTAL_PADDING$1 - OUTLINE_BUTTON_BORDER_WIDTH$1, "px\n      "),
        border: "".concat(OUTLINE_BUTTON_BORDER_WIDTH$1, "px solid ").concat(palette.primary.lightAlt),
        '&:hover, &$focusVisible': {
          backgroundColor: palette.primary.dark,
          border: "3px solid ".concat(palette.primary.dark)
        },
        '&:hover $label, &$focusVisible $label': {
          color: palette.common.white
        },
        '&:active': {
          backgroundColor: secondaryColors.navy,
          border: "".concat(OUTLINE_BUTTON_BORDER_WIDTH$1, "px solid ").concat(secondaryColors.navy),
          color: palette.common.white
        },
        '&$disabled': {
          border: "".concat(OUTLINE_BUTTON_BORDER_WIDTH$1, "px solid ").concat(palette.primary.lightAlt),
      ...
      containedSizeSmall: _extends({}, smallButtonStyles(typography)),
      textSizeSmall: _extends({}, smallButtonStyles(typography)),

      /* Styles applied to the root element if `size="large"` and `variant="contained". */
      containedSizeLarge: _extends({}, largeButtonStyles$1(typography)),
      textSizeLarge: _extends({}, largeButtonStyles$1(typography)),

      /* Styles applied to the root element if `size="small"` and `variant="outlined"`. */
      outlinedSizeSmall: _extends({}, smallButtonStyles(typography), {
        padding: "\n        ".concat(SMALL_BUTTON_VERTICAL_PADDING - OUTLINE_BUTTON_BORDER_WIDTH$1, "px\n        ").concat(SMALL_BUTTON_HORIZONTAL_PADDING - OUTLINE_BUTTON_BORDER_WIDTH$1, "px\n      ")
      }),

      /* Styles applied to the root element if `size="large"` and `variant="outlined"`. */
      outlinedSizeLarge: _extends({}, largeButtonStyles$1(typography), {
        padding: "\n      ".concat(LARGE_BUTTON_VERTICAL_PADDING$1 - OUTLINE_BUTTON_BORDER_WIDTH$1, "px\n      ").concat(LARGE_BUTTON_HORIZONTAL_PADDING$1 - OUTLINE_BUTTON_BORDER_WIDTH$1, "px\n    ")
      })
    },
    MuiFormLabel: {
      root: _extends({}, baselineShift)
    },
    MuiInputBase: {
      input: _extends({}, baselineShift)
    },
    MuiAlert: {
      message: {
        padding: '9px 0 6px'
...
var palette$2 = _extends({}, sharedPalette, {
  action: {
  ...
  grey: _extends({}, warmGreyscaleColors),
  greyTransparent: _extends({}, warmGreyscaleTransparentColors)
});

var typography$2 = (function (theme) {
  var typography = theme.typography;
  var fontWeightBold = typography.fontWeightBold,
      ...
      pxToRem = typography.pxToRem;
  var valueSerif = ['Value Serif', 'Georgia', 'serif'].join(',');
  var spaceMono = ['Space Mono', 'monospace'].join(',');
  return {
...
var marketingTheme = createMuiTheme({
  palette: palette$2,
  props: sharedProps,
  shape: sharedShape,
...
var checkboxAndRadioStyles$1 = function checkboxAndRadioStyles(spacing) {
  return {
    root: {
...
var sharedButtonStyles = function sharedButtonStyles(palette) {
  return {
    '&:active': {
      backgroundColor: palette.primary.light,
  ...
  return {
    ...
    MuiFilledInput: {
      root: {
        ...
        color: palette.common.white,
        '&$focused': {
          backgroundColor: "".concat(whiteTransparentColors[18], "!important"),
          border: "1px solid ".concat(palette.primary.light)
        },
        '&:hover:not($disabled)': {
      ...
      colorSecondary: {
        ...
        '&$focused': {
          ...
          backgroundColor: "".concat(whiteTransparentColors[100], "!important")
        },
        '&:hover:not(&$disabled)': {
          borderColor: palette.primary.main,
          backgroundColor: whiteTransparentColors[100]
    ...
    MuiButton: {
      containedPrimary: _extends({}, sharedButtonStyles(palette), {
        '&$disabled': {
          backgroundColor: palette.primary.main,
          color: whiteTransparentColors[100],
          opacity: 0.4
      ...
      outlinedPrimary: _extends({}, sharedButtonStyles(palette), {
        '&$disabled': {
          borderColor: palette.primary.main,
          color: palette.primary.main,
          opacity: 0.6
      ...
      textPrimary: {
        '&:active': {
          backgroundColor: whiteTransparentColors[18],
          color: "".concat(palette.primary.light, "!important")
        },
        '&:hover': {
          backgroundColor: "".concat(whiteTransparentColors[18], "!important"),
          color: "".concat(legacyColors.blueLightAccent, "!important")
        },
        '&$disabled': {
          opacity: 0.6
        }
    ...
    MuiCheckbox: _extends({}, checkboxAndRadioStyles$1(spacing)),
    MuiRadio: _extends({}, checkboxAndRadioStyles$1(spacing)),
    MuiSelect: {
      iconFilled: {
    ...
    MuiAutocomplete: {
      ...
      groupLabel: {
        backgroundColor: 'transparent',
        borderBottom: "1px solid ".concat(whiteTransparentColors[5]),
        color: whiteTransparentColors[80],
    ...
    MuiToggleButton: {
      root: _extends({}, typography.button, {
        ...
        '&[class*="MuiToggleButtonGroup-grouped"]': {
          border: "1px solid ".concat(legacyColors.blueMediumDark),
          marginRight: 0,
          paddingLeft: 7,
          paddingRight: 7,
          '&[class*="selected"]': {
            borderBottom: "3px solid ".concat(palette.primary.light),
            paddingTop: 7,
            paddingBottom: 5
          }
        }
    ...
    MuiSwitch: {
      ...
      colorPrimary: {
        ...
        '&$checked:hover, &$checked.Mui-focusVisible': {
          backgroundColor: "".concat(lighten("rgba(".concat(hexToRgb(legacyColors.blueLighter), ", 0.4))"), 0.4), " !important")
        },
        '&$checked:active': {
          backgroundColor: palette.primary.main
        }
...
var palette$3 = _extends({}, sharedPalette, {
  action: {
...
var typography$3 = (function (theme) {
  var typography = theme.typography;
...
var defaultTheme$2 = createMuiTheme();
var leadsThemeProps = {
  MuiFilledInput: {
...
var ProductThemeProvider = function ProductThemeProvider(_ref) {
  var children = _ref.children,
      variant = _ref.variant;
...
var MarketingThemeProvider = function MarketingThemeProvider(_ref2) {
  var children = _ref2.children;
  return /*#__PURE__*/React.createElement(ThemeProvider, {
...
var LeadsThemeProvider = function LeadsThemeProvider(_ref3) {
...
var _ref$2 = /*#__PURE__*/React.createElement(CssBaseline, null);

var _ref2$p = /*#__PURE__*/React.createElement(CssBaseline, null);

var _ref3$6 = /*#__PURE__*/React.createElement(CssBaseline, null);

var getThemeDecorator = function getThemeDecorator() {
  var themeName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'product';

  if (themeName === 'marketing') {
    return function (storyFn) {
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(MarketingThemeProvider, null, _ref$2, storyFn()));
    };
  }
  ...
  if (themeName === 'leads') {
    return function (storyFn) {
      return /*#__PURE__*/React.createElement(Box, {
        ...
        pt: 2,
        pb: 2
      }, /*#__PURE__*/React.createElement(LeadsThemeProvider, null, _ref2$p, storyFn()));
    };
  }

  return function (storyFn) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ProductThemeProvider, null, _ref3$6, storyFn()));
  };
};

export { ArrowPopper, WrappedBanner as Banner, BundleInfoSheet, Checklist, ChecklistCelebrationModal, ChecklistItemDetails, ClickShield, ColorPicker, ConfirmDialog, DialogTitleWithCloseButton, EntityTable, FeedbackTool, FlyoutMenu, FullScreenDialog, FullScreenDialogHeader, FullScreenDialogTitle, Illustration, InfoSheet, InputLabelWithCount, InputLabelWithTooltip, LeadpagesLogo, LeadsThemeProvider, LoadingButton, MarketingThemeProvider, Onboarding, PasswordTextField, PhoneInput, ProductThemeProvider, ShadowBox, index$2 as Shapes, Toast, UnderlineLink, UserCheckList, VSTypography, WistiaEmbed, getThemeDecorator, index$1 as illustrationTypes, leadsTheme, marketingTheme, productTheme, useSuccess };
