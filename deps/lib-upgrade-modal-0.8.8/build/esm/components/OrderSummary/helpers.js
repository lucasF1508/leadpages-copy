...
export var CYCLE_LABEL = (_CYCLE_LABEL = {}, _defineProperty(_CYCLE_LABEL, PLAN_PERIODS.MONTHLY, 'per month'), _defineProperty(_CYCLE_LABEL, PLAN_PERIODS.ANNUAL, 'per year'), _CYCLE_LABEL);

function getEndOfMonth(currentDate) {
  return new Date(currentDate.getFullYear(), currentDate.getMonth() + 1, 0);
}

export function getNormalBillingDate(discountBillingCycles, period, paidStartDate) {
