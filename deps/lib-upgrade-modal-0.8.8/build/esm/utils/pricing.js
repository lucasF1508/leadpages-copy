...
export function getDisplayPrices(plan, allPlans, currentPlan, coupon, flow) {
  ...
  var isAnnualPlan = plan.period === PLAN_PERIODS.ANNUAL;
  var isCurrentPlan = planLevel.toLowerCase() === (currentPlan === null || currentPlan === void 0 ? void 0 : currentPlan.level);
  var hasCoupon = !!coupon;
  var couponAppliesToPlan = checkPlanIsUpgrade(plan, flow) && checkPlanCouponEligibility(plan, coupon, flow);
  ...
  if (isAnnualPlan && !hasCoupon && !hasDiscount) {
    ...
    var matchingMonthlyPlanLevelPrice = (_allPlans$PLAN_PERIOD = allPlans[PLAN_PERIODS.MONTHLY]) === null || _allPlans$PLAN_PERIOD === void 0 ? void 0 : (_allPlans$PLAN_PERIOD2 = _allPlans$PLAN_PERIOD[planLevel.toLowerCase()]) === null || _allPlans$PLAN_PERIOD2 === void 0 ? void 0 : _allPlans$PLAN_PERIOD2.monthlyPrice;
